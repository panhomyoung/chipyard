...
module ALUUnit_1(
  ...
  wire [15:0] _T_1 = io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask;	// @[util.scala:118:51]
  ...
  always @(posedge clock) begin
    if (reset)
      ...
      r_valids_0 <= io_req_valid & _T_1 == 16'h0 & ~io_req_bits_kill;	// @[functional-unit.scala:226:27, :230:{84,87}, util.scala:118:{51,59}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_br_mask = {_RANDOM_4[31:29], _RANDOM_5[12:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = {_RANDOM_5[31], _RANDOM_6[18:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = {_RANDOM_6[31], _RANDOM_7[6:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[24:19];	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_10[28];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_11[7];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_11[9];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_12[8:7];	// @[functional-unit.scala:227:23]
        r_data_0 = {_RANDOM_12[31:26], _RANDOM_13, _RANDOM_14[25:0]};	// @[functional-unit.scala:227:23, :437:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_resp_valid = r_valids_0 & (io_brupdate_b1_mispredict_mask & r_uops_0_br_mask) == 16'h0;	// @[functional-unit.scala:226:27, :227:23, :247:47, util.scala:118:{51,59}]
