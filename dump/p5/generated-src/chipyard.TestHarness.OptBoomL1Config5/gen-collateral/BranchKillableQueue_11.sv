...
module BranchKillableQueue_11(
  ...
  wire [3:0][15:0] _GEN_2 = {{uops_0_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [15:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [3:0][7:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [3:0][4:0]  _GEN_4 = {{uops_0_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  wire [3:0][5:0]  _GEN_5 = {{uops_0_pdst}, {uops_2_pdst}, {uops_1_pdst}, {uops_0_pdst}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 2'h0) & (_GEN_11 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_1 <= ~(do_deq & deq_ptr_value == 2'h1) & (_GEN_13 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_2 <= ~(do_deq & deq_ptr_value == 2'h2) & (_GEN_15 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = {_RANDOM_4[31], _RANDOM_5[14:0]};	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_7[8:1];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[18:14];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[26:21];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[9];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[11];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[10:9];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[16];	// @[util.scala:466:20]
        uops_1_uopc = {_RANDOM_12[31:27], _RANDOM_13[1:0]};	// @[util.scala:466:20]
        uops_1_br_mask = {_RANDOM_17[31:23], _RANDOM_18[6:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_19[31:25], _RANDOM_20[0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[10:6];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[18:13];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[1];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[3];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[2:1];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[8];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_25[25:19];	// @[util.scala:466:20]
        uops_2_br_mask = _RANDOM_30[30:15];	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_32[24:17];	// @[util.scala:466:20]
        uops_2_stq_idx = {_RANDOM_32[31:30], _RANDOM_33[2:0]};	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[10:5];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_36[25];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_36[27];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_37[26:25];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[0];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_38[12:11];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_38[14:13];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_38[15];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_28 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_bits_fflags_valid = ~_io_empty_output & _ram_ext_R0_data[474];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? 8'h0 : _ram_ext_R0_data[704:697];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? 5'h0 : _ram_ext_R0_data[887:883];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
