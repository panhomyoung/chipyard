...
module TLMonitor_55(
  ...
  `ifndef SYNTHESIS
    ...
    wire  [15:0]     _T_768 = 16'h0 >> _GEN_1;	// @[Monitor.scala:723:35, :793:25, OneHot.scala:57:35]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (~reset & ~(a_set_wo_ready != (_T_710 & ~d_release_ack ? 16'h1 << _GEN_1 : 16'h0) | a_set_wo_ready == 16'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
