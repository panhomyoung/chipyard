...
module Repeater_1(
  ...
  reg  [1:0]   saved_sink;	// @[Repeater.scala:20:18]
  ...
  always @(posedge clock) begin
    ...
    saved_source <= ~_T_1 & saved_source;	// @[Repeater.scala:20:18, :28:{23,38,62}]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_param = _RANDOM_0[5:4];	// @[Repeater.scala:19:21, :20:18]
        saved_size = _RANDOM_0[9:6];	// @[Repeater.scala:19:21, :20:18]
        saved_source = _RANDOM_0[10];	// @[Repeater.scala:19:21, :20:18]
        saved_sink = _RANDOM_0[12:11];	// @[Repeater.scala:19:21, :20:18]
        saved_denied = _RANDOM_0[13];	// @[Repeater.scala:19:21, :20:18]
        saved_data = {_RANDOM_0[31:14], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[13:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_4[14];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_deq_bits_source = full & saved_source;	// @[Repeater.scala:19:21, :20:18, :25:21]
