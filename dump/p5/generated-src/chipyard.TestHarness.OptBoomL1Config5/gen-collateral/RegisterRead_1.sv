...
module RegisterRead_1(
  ...
  input  [7:0]  io_iss_uops_0_rob_idx,
  ...
  input  [7:0]  io_iss_uops_1_rob_idx,
  ...
  input  [7:0]  io_iss_uops_2_rob_idx,
  input  [4:0]  io_iss_uops_2_ldq_idx,
                io_iss_uops_2_stq_idx,
  input  [5:0]  io_iss_uops_2_pdst,
                io_iss_uops_2_prs1,
                io_iss_uops_2_prs2,
  ...
  input  [5:0]  io_bypass_3_bits_uop_pdst,
  ...
  output [7:0]  io_exe_reqs_0_bits_uop_rob_idx,
  ...
  output [7:0]  io_exe_reqs_1_bits_uop_rob_idx,
  ...
  output [7:0]  io_exe_reqs_2_bits_uop_rob_idx,
  output [4:0]  io_exe_reqs_2_bits_uop_ldq_idx,
                io_exe_reqs_2_bits_uop_stq_idx,
  output [5:0]  io_exe_reqs_2_bits_uop_pdst,
  ...
  wire [7:0]  _rrd_decode_unit_2_io_rrd_uop_rob_idx;	// @[register-read.scala:80:33]
  ...
  wire [5:0]  _rrd_decode_unit_2_io_rrd_uop_pdst;	// @[register-read.scala:80:33]
  wire [5:0]  _rrd_decode_unit_2_io_rrd_uop_prs1;	// @[register-read.scala:80:33]
  wire [5:0]  _rrd_decode_unit_2_io_rrd_uop_prs2;	// @[register-read.scala:80:33]
  ...
  wire [7:0]  _rrd_decode_unit_1_io_rrd_uop_rob_idx;	// @[register-read.scala:80:33]
  ...
  wire [7:0]  _rrd_decode_unit_io_rrd_uop_rob_idx;	// @[register-read.scala:80:33]
  ...
  reg  [7:0]  exe_reg_uops_0_rob_idx;	// @[register-read.scala:70:29]
  ...
  reg  [7:0]  exe_reg_uops_1_rob_idx;	// @[register-read.scala:70:29]
  ...
  reg  [7:0]  exe_reg_uops_2_rob_idx;	// @[register-read.scala:70:29]
  reg  [4:0]  exe_reg_uops_2_ldq_idx;	// @[register-read.scala:70:29]
  reg  [4:0]  exe_reg_uops_2_stq_idx;	// @[register-read.scala:70:29]
  reg  [5:0]  exe_reg_uops_2_pdst;	// @[register-read.scala:70:29]
  reg  [5:0]  exe_reg_uops_2_prs1;	// @[register-read.scala:70:29]
  ...
  reg  [7:0]  rrd_uops_0_REG_rob_idx;	// @[register-read.scala:86:29]
  ...
  reg  [7:0]  rrd_uops_1_REG_rob_idx;	// @[register-read.scala:86:29]
  ...
  reg  [7:0]  rrd_uops_2_REG_rob_idx;	// @[register-read.scala:86:29]
  reg  [4:0]  rrd_uops_2_REG_ldq_idx;	// @[register-read.scala:86:29]
  reg  [4:0]  rrd_uops_2_REG_stq_idx;	// @[register-read.scala:86:29]
  reg  [5:0]  rrd_uops_2_REG_pdst;	// @[register-read.scala:86:29]
  reg  [5:0]  rrd_uops_2_REG_prs1;	// @[register-read.scala:86:29]
  reg  [5:0]  rrd_uops_2_REG_prs2;	// @[register-read.scala:86:29]
  ...
  always @(posedge clock) begin
    ...
    if (rrd_kill) begin	// @[register-read.scala:130:28]
      ...
      exe_reg_uops_0_rob_idx <= 8'h0;	// @[consts.scala:270:20, register-read.scala:70:29]
      ...
      exe_reg_uops_0_pdst <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_0_prs1 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_0_prs2 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_0_prs3 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_0_ppred <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_0_stale_pdst <= 6'h0;	// @[register-read.scala:70:29, :103:21]
    ...
    if (rrd_kill_1) begin	// @[register-read.scala:130:28]
      ...
      exe_reg_uops_1_rob_idx <= 8'h0;	// @[consts.scala:270:20, register-read.scala:70:29]
      ...
      exe_reg_uops_1_pdst <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_1_prs1 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_1_prs2 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_1_prs3 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_1_ppred <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_1_stale_pdst <= 6'h0;	// @[register-read.scala:70:29, :103:21]
    ...
    if (rrd_kill_2) begin	// @[register-read.scala:130:28]
      exe_reg_uops_2_uopc <= 7'h0;	// @[consts.scala:271:20, register-read.scala:70:29]
      ...
      exe_reg_uops_2_rob_idx <= 8'h0;	// @[consts.scala:270:20, register-read.scala:70:29]
      ...
      exe_reg_uops_2_pdst <= 6'h0;	// @[register-read.scala:70:29, :103:21]
      exe_reg_uops_2_prs1 <= 6'h0;	// @[register-read.scala:70:29, :103:21]
    ...
    rrd_rs1_data_0_REG <= io_iss_uops_0_prs1 == 6'h0;	// @[register-read.scala:103:21, :124:{57,67}]
    rrd_rs2_data_0_REG <= io_iss_uops_0_prs2 == 6'h0;	// @[register-read.scala:103:21, :125:{57,67}]
    rrd_rs1_data_1_REG <= io_iss_uops_1_prs1 == 6'h0;	// @[register-read.scala:103:21, :124:{57,67}]
    rrd_rs2_data_1_REG <= io_iss_uops_1_prs2 == 6'h0;	// @[register-read.scala:103:21, :125:{57,67}]
    rrd_rs1_data_2_REG <= io_iss_uops_2_prs1 == 6'h0;	// @[register-read.scala:103:21, :124:{57,67}]
    rrd_rs2_data_2_REG <= io_iss_uops_2_prs2 == 6'h0;	// @[register-read.scala:103:21, :125:{57,67}]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        exe_reg_uops_0_br_mask = {_RANDOM_4[31], _RANDOM_5[14:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_br_tag = _RANDOM_5[18:15];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ftq_idx = _RANDOM_5[24:19];	// @[register-read.scala:70:29]
        ...
        exe_reg_uops_0_rob_idx = _RANDOM_7[8:1];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldq_idx = _RANDOM_7[13:9];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stq_idx = _RANDOM_7[18:14];	// @[register-read.scala:70:29]
        exe_reg_uops_0_rxq_idx = _RANDOM_7[20:19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_pdst = _RANDOM_7[26:21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1 = {_RANDOM_7[31:27], _RANDOM_8[0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2 = _RANDOM_8[6:1];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3 = _RANDOM_8[12:7];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred = _RANDOM_8[18:13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs1_busy = _RANDOM_8[19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs2_busy = _RANDOM_8[20];	// @[register-read.scala:70:29]
        exe_reg_uops_0_prs3_busy = _RANDOM_8[21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ppred_busy = _RANDOM_8[22];	// @[register-read.scala:70:29]
        exe_reg_uops_0_stale_pdst = _RANDOM_8[28:23];	// @[register-read.scala:70:29]
        exe_reg_uops_0_exception = _RANDOM_8[29];	// @[register-read.scala:70:29]
        exe_reg_uops_0_exc_cause = {_RANDOM_8[31:30], _RANDOM_9, _RANDOM_10[29:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_bypassable = _RANDOM_10[30];	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_cmd = {_RANDOM_10[31], _RANDOM_11[3:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_size = _RANDOM_11[5:4];	// @[register-read.scala:70:29]
        exe_reg_uops_0_mem_signed = _RANDOM_11[6];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_fence = _RANDOM_11[7];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_fencei = _RANDOM_11[8];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_amo = _RANDOM_11[9];	// @[register-read.scala:70:29]
        exe_reg_uops_0_uses_ldq = _RANDOM_11[10];	// @[register-read.scala:70:29]
        exe_reg_uops_0_uses_stq = _RANDOM_11[11];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_sys_pc2epc = _RANDOM_11[12];	// @[register-read.scala:70:29]
        exe_reg_uops_0_is_unique = _RANDOM_11[13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_flush_on_commit = _RANDOM_11[14];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst_is_rs1 = _RANDOM_11[15];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst = _RANDOM_11[21:16];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs1 = _RANDOM_11[27:22];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs2 = {_RANDOM_11[31:28], _RANDOM_12[1:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs3 = _RANDOM_12[7:2];	// @[register-read.scala:70:29]
        exe_reg_uops_0_ldst_val = _RANDOM_12[8];	// @[register-read.scala:70:29]
        exe_reg_uops_0_dst_rtype = _RANDOM_12[10:9];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs1_rtype = _RANDOM_12[12:11];	// @[register-read.scala:70:29]
        exe_reg_uops_0_lrs2_rtype = _RANDOM_12[14:13];	// @[register-read.scala:70:29]
        exe_reg_uops_0_frs3_en = _RANDOM_12[15];	// @[register-read.scala:70:29]
        exe_reg_uops_0_fp_val = _RANDOM_12[16];	// @[register-read.scala:70:29]
        exe_reg_uops_0_fp_single = _RANDOM_12[17];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_pf_if = _RANDOM_12[18];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_ae_if = _RANDOM_12[19];	// @[register-read.scala:70:29]
        exe_reg_uops_0_xcpt_ma_if = _RANDOM_12[20];	// @[register-read.scala:70:29]
        exe_reg_uops_0_bp_debug_if = _RANDOM_12[21];	// @[register-read.scala:70:29]
        exe_reg_uops_0_bp_xcpt_if = _RANDOM_12[22];	// @[register-read.scala:70:29]
        exe_reg_uops_0_debug_fsrc = _RANDOM_12[24:23];	// @[register-read.scala:70:29]
        exe_reg_uops_0_debug_tsrc = _RANDOM_12[26:25];	// @[register-read.scala:70:29]
        exe_reg_uops_1_uopc = {_RANDOM_12[31:27], _RANDOM_13[1:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_inst = {_RANDOM_13[31:2], _RANDOM_14[1:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_debug_inst = {_RANDOM_14[31:2], _RANDOM_15[1:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_rvc = _RANDOM_15[2];	// @[register-read.scala:70:29]
        exe_reg_uops_1_debug_pc = {_RANDOM_15[31:3], _RANDOM_16[10:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_iq_type = _RANDOM_16[13:11];	// @[register-read.scala:70:29]
        exe_reg_uops_1_fu_code = _RANDOM_16[23:14];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_br_type = _RANDOM_16[27:24];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_op1_sel = _RANDOM_16[29:28];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_op2_sel = {_RANDOM_16[31:30], _RANDOM_17[0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_imm_sel = _RANDOM_17[3:1];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_op_fcn = _RANDOM_17[7:4];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_fcn_dw = _RANDOM_17[8];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_csr_cmd = _RANDOM_17[11:9];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_is_load = _RANDOM_17[12];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_is_sta = _RANDOM_17[13];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ctrl_is_std = _RANDOM_17[14];	// @[register-read.scala:70:29]
        exe_reg_uops_1_iw_state = _RANDOM_17[16:15];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_br = _RANDOM_17[19];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_jalr = _RANDOM_17[20];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_jal = _RANDOM_17[21];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_sfb = _RANDOM_17[22];	// @[register-read.scala:70:29]
        exe_reg_uops_1_br_mask = {_RANDOM_17[31:23], _RANDOM_18[6:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_br_tag = _RANDOM_18[10:7];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ftq_idx = _RANDOM_18[16:11];	// @[register-read.scala:70:29]
        exe_reg_uops_1_edge_inst = _RANDOM_18[17];	// @[register-read.scala:70:29]
        exe_reg_uops_1_pc_lob = _RANDOM_18[23:18];	// @[register-read.scala:70:29]
        exe_reg_uops_1_taken = _RANDOM_18[24];	// @[register-read.scala:70:29]
        exe_reg_uops_1_imm_packed = {_RANDOM_18[31:25], _RANDOM_19[12:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_csr_addr = _RANDOM_19[24:13];	// @[register-read.scala:70:29]
        exe_reg_uops_1_rob_idx = {_RANDOM_19[31:25], _RANDOM_20[0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_ldq_idx = _RANDOM_20[5:1];	// @[register-read.scala:70:29]
        exe_reg_uops_1_stq_idx = _RANDOM_20[10:6];	// @[register-read.scala:70:29]
        exe_reg_uops_1_rxq_idx = _RANDOM_20[12:11];	// @[register-read.scala:70:29]
        exe_reg_uops_1_pdst = _RANDOM_20[18:13];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs1 = _RANDOM_20[24:19];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs2 = _RANDOM_20[30:25];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs3 = {_RANDOM_20[31], _RANDOM_21[4:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_ppred = _RANDOM_21[10:5];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs1_busy = _RANDOM_21[11];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs2_busy = _RANDOM_21[12];	// @[register-read.scala:70:29]
        exe_reg_uops_1_prs3_busy = _RANDOM_21[13];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ppred_busy = _RANDOM_21[14];	// @[register-read.scala:70:29]
        exe_reg_uops_1_stale_pdst = _RANDOM_21[20:15];	// @[register-read.scala:70:29]
        exe_reg_uops_1_exception = _RANDOM_21[21];	// @[register-read.scala:70:29]
        exe_reg_uops_1_exc_cause = {_RANDOM_21[31:22], _RANDOM_22, _RANDOM_23[21:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_1_bypassable = _RANDOM_23[22];	// @[register-read.scala:70:29]
        exe_reg_uops_1_mem_cmd = _RANDOM_23[27:23];	// @[register-read.scala:70:29]
        exe_reg_uops_1_mem_size = _RANDOM_23[29:28];	// @[register-read.scala:70:29]
        exe_reg_uops_1_mem_signed = _RANDOM_23[30];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_fence = _RANDOM_23[31];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_fencei = _RANDOM_24[0];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_amo = _RANDOM_24[1];	// @[register-read.scala:70:29]
        exe_reg_uops_1_uses_ldq = _RANDOM_24[2];	// @[register-read.scala:70:29]
        exe_reg_uops_1_uses_stq = _RANDOM_24[3];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_sys_pc2epc = _RANDOM_24[4];	// @[register-read.scala:70:29]
        exe_reg_uops_1_is_unique = _RANDOM_24[5];	// @[register-read.scala:70:29]
        exe_reg_uops_1_flush_on_commit = _RANDOM_24[6];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ldst_is_rs1 = _RANDOM_24[7];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ldst = _RANDOM_24[13:8];	// @[register-read.scala:70:29]
        exe_reg_uops_1_lrs1 = _RANDOM_24[19:14];	// @[register-read.scala:70:29]
        exe_reg_uops_1_lrs2 = _RANDOM_24[25:20];	// @[register-read.scala:70:29]
        exe_reg_uops_1_lrs3 = _RANDOM_24[31:26];	// @[register-read.scala:70:29]
        exe_reg_uops_1_ldst_val = _RANDOM_25[0];	// @[register-read.scala:70:29]
        exe_reg_uops_1_dst_rtype = _RANDOM_25[2:1];	// @[register-read.scala:70:29]
        exe_reg_uops_1_lrs1_rtype = _RANDOM_25[4:3];	// @[register-read.scala:70:29]
        exe_reg_uops_1_lrs2_rtype = _RANDOM_25[6:5];	// @[register-read.scala:70:29]
        exe_reg_uops_1_frs3_en = _RANDOM_25[7];	// @[register-read.scala:70:29]
        exe_reg_uops_1_fp_val = _RANDOM_25[8];	// @[register-read.scala:70:29]
        exe_reg_uops_1_fp_single = _RANDOM_25[9];	// @[register-read.scala:70:29]
        exe_reg_uops_1_xcpt_pf_if = _RANDOM_25[10];	// @[register-read.scala:70:29]
        exe_reg_uops_1_xcpt_ae_if = _RANDOM_25[11];	// @[register-read.scala:70:29]
        exe_reg_uops_1_xcpt_ma_if = _RANDOM_25[12];	// @[register-read.scala:70:29]
        exe_reg_uops_1_bp_debug_if = _RANDOM_25[13];	// @[register-read.scala:70:29]
        exe_reg_uops_1_bp_xcpt_if = _RANDOM_25[14];	// @[register-read.scala:70:29]
        exe_reg_uops_1_debug_fsrc = _RANDOM_25[16:15];	// @[register-read.scala:70:29]
        exe_reg_uops_1_debug_tsrc = _RANDOM_25[18:17];	// @[register-read.scala:70:29]
        exe_reg_uops_2_uopc = _RANDOM_25[25:19];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_rvc = _RANDOM_27[26];	// @[register-read.scala:70:29]
        exe_reg_uops_2_fu_code = _RANDOM_29[15:6];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_br_type = _RANDOM_29[19:16];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_op1_sel = _RANDOM_29[21:20];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_op2_sel = _RANDOM_29[24:22];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_imm_sel = _RANDOM_29[27:25];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_op_fcn = _RANDOM_29[31:28];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_fcn_dw = _RANDOM_30[0];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ctrl_csr_cmd = _RANDOM_30[3:1];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_br = _RANDOM_30[11];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_jalr = _RANDOM_30[12];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_jal = _RANDOM_30[13];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_sfb = _RANDOM_30[14];	// @[register-read.scala:70:29]
        exe_reg_uops_2_br_mask = _RANDOM_30[30:15];	// @[register-read.scala:70:29]
        exe_reg_uops_2_br_tag = {_RANDOM_30[31], _RANDOM_31[2:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_2_ftq_idx = _RANDOM_31[8:3];	// @[register-read.scala:70:29]
        exe_reg_uops_2_edge_inst = _RANDOM_31[9];	// @[register-read.scala:70:29]
        exe_reg_uops_2_pc_lob = _RANDOM_31[15:10];	// @[register-read.scala:70:29]
        exe_reg_uops_2_taken = _RANDOM_31[16];	// @[register-read.scala:70:29]
        exe_reg_uops_2_imm_packed = {_RANDOM_31[31:17], _RANDOM_32[4:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_2_rob_idx = _RANDOM_32[24:17];	// @[register-read.scala:70:29]
        exe_reg_uops_2_ldq_idx = _RANDOM_32[29:25];	// @[register-read.scala:70:29]
        exe_reg_uops_2_stq_idx = {_RANDOM_32[31:30], _RANDOM_33[2:0]};	// @[register-read.scala:70:29]
        exe_reg_uops_2_pdst = _RANDOM_33[10:5];	// @[register-read.scala:70:29]
        exe_reg_uops_2_prs1 = _RANDOM_33[16:11];	// @[register-read.scala:70:29]
        exe_reg_uops_2_bypassable = _RANDOM_36[14];	// @[register-read.scala:70:29]
        exe_reg_uops_2_is_amo = _RANDOM_36[25];	// @[register-read.scala:70:29]
        exe_reg_uops_2_uses_stq = _RANDOM_36[27];	// @[register-read.scala:70:29]
        exe_reg_uops_2_dst_rtype = _RANDOM_37[26:25];	// @[register-read.scala:70:29]
        exe_reg_rs1_data_0 = {_RANDOM_38[31:11], _RANDOM_39, _RANDOM_40[10:0]};	// @[register-read.scala:71:29]
        exe_reg_rs1_data_1 = {_RANDOM_40[31:11], _RANDOM_41, _RANDOM_42[10:0]};	// @[register-read.scala:71:29]
        exe_reg_rs1_data_2 = {_RANDOM_42[31:11], _RANDOM_43, _RANDOM_44[10:0]};	// @[register-read.scala:71:29]
        exe_reg_rs2_data_0 = {_RANDOM_44[31:11], _RANDOM_45, _RANDOM_46[10:0]};	// @[register-read.scala:71:29, :72:29]
        exe_reg_rs2_data_1 = {_RANDOM_46[31:11], _RANDOM_47, _RANDOM_48[10:0]};	// @[register-read.scala:72:29]
        exe_reg_rs2_data_2 = {_RANDOM_48[31:11], _RANDOM_49, _RANDOM_50[10:0]};	// @[register-read.scala:72:29]
        rrd_valids_0_REG = _RANDOM_56[14];	// @[register-read.scala:84:29]
        rrd_uops_0_REG_uopc = _RANDOM_56[21:15];	// @[register-read.scala:84:29, :86:29]
        rrd_uops_0_REG_inst = {_RANDOM_56[31:22], _RANDOM_57[21:0]};	// @[register-read.scala:84:29, :86:29]
        rrd_uops_0_REG_debug_inst = {_RANDOM_57[31:22], _RANDOM_58[21:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_rvc = _RANDOM_58[22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_pc = {_RANDOM_58[31:23], _RANDOM_59[30:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iq_type = {_RANDOM_59[31], _RANDOM_60[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fu_code = _RANDOM_60[11:2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_br_type = _RANDOM_60[15:12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op1_sel = _RANDOM_60[17:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op2_sel = _RANDOM_60[20:18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_imm_sel = _RANDOM_60[23:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_op_fcn = _RANDOM_60[27:24];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_fcn_dw = _RANDOM_60[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_csr_cmd = _RANDOM_60[31:29];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_load = _RANDOM_61[0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_sta = _RANDOM_61[1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ctrl_is_std = _RANDOM_61[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_iw_state = _RANDOM_61[4:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_br = _RANDOM_61[7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jalr = _RANDOM_61[8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_jal = _RANDOM_61[9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sfb = _RANDOM_61[10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_mask = _RANDOM_61[26:11];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_br_tag = _RANDOM_61[30:27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ftq_idx = {_RANDOM_61[31], _RANDOM_62[4:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_edge_inst = _RANDOM_62[5];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_pc_lob = _RANDOM_62[11:6];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_taken = _RANDOM_62[12];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_imm_packed = {_RANDOM_62[31:13], _RANDOM_63[0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_csr_addr = _RANDOM_63[12:1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_rob_idx = _RANDOM_63[20:13];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldq_idx = _RANDOM_63[25:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_stq_idx = _RANDOM_63[30:26];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_rxq_idx = {_RANDOM_63[31], _RANDOM_64[0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_pdst = _RANDOM_64[6:1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1 = _RANDOM_64[12:7];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2 = _RANDOM_64[18:13];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3 = _RANDOM_64[24:19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred = _RANDOM_64[30:25];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs1_busy = _RANDOM_64[31];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs2_busy = _RANDOM_65[0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_prs3_busy = _RANDOM_65[1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ppred_busy = _RANDOM_65[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_stale_pdst = _RANDOM_65[8:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exception = _RANDOM_65[9];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_exc_cause = {_RANDOM_65[31:10], _RANDOM_66, _RANDOM_67[9:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bypassable = _RANDOM_67[10];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_cmd = _RANDOM_67[15:11];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_size = _RANDOM_67[17:16];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_mem_signed = _RANDOM_67[18];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fence = _RANDOM_67[19];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_fencei = _RANDOM_67[20];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_amo = _RANDOM_67[21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_ldq = _RANDOM_67[22];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_uses_stq = _RANDOM_67[23];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_sys_pc2epc = _RANDOM_67[24];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_is_unique = _RANDOM_67[25];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_flush_on_commit = _RANDOM_67[26];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_is_rs1 = _RANDOM_67[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst = {_RANDOM_67[31:28], _RANDOM_68[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1 = _RANDOM_68[7:2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2 = _RANDOM_68[13:8];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs3 = _RANDOM_68[19:14];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_ldst_val = _RANDOM_68[20];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_dst_rtype = _RANDOM_68[22:21];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs1_rtype = _RANDOM_68[24:23];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_lrs2_rtype = _RANDOM_68[26:25];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_frs3_en = _RANDOM_68[27];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_val = _RANDOM_68[28];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_fp_single = _RANDOM_68[29];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_pf_if = _RANDOM_68[30];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ae_if = _RANDOM_68[31];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_xcpt_ma_if = _RANDOM_69[0];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_debug_if = _RANDOM_69[1];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_bp_xcpt_if = _RANDOM_69[2];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_fsrc = _RANDOM_69[4:3];	// @[register-read.scala:86:29]
        rrd_uops_0_REG_debug_tsrc = _RANDOM_69[6:5];	// @[register-read.scala:86:29]
        rrd_valids_1_REG = _RANDOM_69[7];	// @[register-read.scala:84:29, :86:29]
        rrd_uops_1_REG_uopc = _RANDOM_69[14:8];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_inst = {_RANDOM_69[31:15], _RANDOM_70[14:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_debug_inst = {_RANDOM_70[31:15], _RANDOM_71[14:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_rvc = _RANDOM_71[15];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_debug_pc = {_RANDOM_71[31:16], _RANDOM_72[23:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_iq_type = _RANDOM_72[26:24];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_fu_code = {_RANDOM_72[31:27], _RANDOM_73[4:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_br_type = _RANDOM_73[8:5];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_op1_sel = _RANDOM_73[10:9];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_op2_sel = _RANDOM_73[13:11];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_imm_sel = _RANDOM_73[16:14];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_op_fcn = _RANDOM_73[20:17];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_fcn_dw = _RANDOM_73[21];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_csr_cmd = _RANDOM_73[24:22];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_is_load = _RANDOM_73[25];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_is_sta = _RANDOM_73[26];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ctrl_is_std = _RANDOM_73[27];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_iw_state = _RANDOM_73[29:28];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_br = _RANDOM_74[0];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_jalr = _RANDOM_74[1];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_jal = _RANDOM_74[2];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_sfb = _RANDOM_74[3];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_br_mask = _RANDOM_74[19:4];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_br_tag = _RANDOM_74[23:20];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ftq_idx = _RANDOM_74[29:24];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_edge_inst = _RANDOM_74[30];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_pc_lob = {_RANDOM_74[31], _RANDOM_75[4:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_taken = _RANDOM_75[5];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_imm_packed = _RANDOM_75[25:6];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_csr_addr = {_RANDOM_75[31:26], _RANDOM_76[5:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_rob_idx = _RANDOM_76[13:6];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ldq_idx = _RANDOM_76[18:14];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_stq_idx = _RANDOM_76[23:19];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_rxq_idx = _RANDOM_76[25:24];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_pdst = _RANDOM_76[31:26];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs1 = _RANDOM_77[5:0];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs2 = _RANDOM_77[11:6];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs3 = _RANDOM_77[17:12];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ppred = _RANDOM_77[23:18];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs1_busy = _RANDOM_77[24];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs2_busy = _RANDOM_77[25];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_prs3_busy = _RANDOM_77[26];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ppred_busy = _RANDOM_77[27];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_stale_pdst = {_RANDOM_77[31:28], _RANDOM_78[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_exception = _RANDOM_78[2];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_exc_cause = {_RANDOM_78[31:3], _RANDOM_79, _RANDOM_80[2:0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_bypassable = _RANDOM_80[3];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_mem_cmd = _RANDOM_80[8:4];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_mem_size = _RANDOM_80[10:9];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_mem_signed = _RANDOM_80[11];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_fence = _RANDOM_80[12];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_fencei = _RANDOM_80[13];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_amo = _RANDOM_80[14];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_uses_ldq = _RANDOM_80[15];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_uses_stq = _RANDOM_80[16];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_sys_pc2epc = _RANDOM_80[17];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_is_unique = _RANDOM_80[18];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_flush_on_commit = _RANDOM_80[19];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ldst_is_rs1 = _RANDOM_80[20];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ldst = _RANDOM_80[26:21];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_lrs1 = {_RANDOM_80[31:27], _RANDOM_81[0]};	// @[register-read.scala:86:29]
        rrd_uops_1_REG_lrs2 = _RANDOM_81[6:1];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_lrs3 = _RANDOM_81[12:7];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_ldst_val = _RANDOM_81[13];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_dst_rtype = _RANDOM_81[15:14];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_lrs1_rtype = _RANDOM_81[17:16];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_lrs2_rtype = _RANDOM_81[19:18];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_frs3_en = _RANDOM_81[20];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_fp_val = _RANDOM_81[21];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_fp_single = _RANDOM_81[22];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_xcpt_pf_if = _RANDOM_81[23];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_xcpt_ae_if = _RANDOM_81[24];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_xcpt_ma_if = _RANDOM_81[25];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_bp_debug_if = _RANDOM_81[26];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_bp_xcpt_if = _RANDOM_81[27];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_debug_fsrc = _RANDOM_81[29:28];	// @[register-read.scala:86:29]
        rrd_uops_1_REG_debug_tsrc = _RANDOM_81[31:30];	// @[register-read.scala:86:29]
        rrd_valids_2_REG = _RANDOM_82[0];	// @[register-read.scala:84:29]
        rrd_uops_2_REG_uopc = _RANDOM_82[7:1];	// @[register-read.scala:84:29, :86:29]
        rrd_uops_2_REG_is_rvc = _RANDOM_84[8];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_fu_code = _RANDOM_85[29:20];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_br_type = {_RANDOM_85[31:30], _RANDOM_86[1:0]};	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_op1_sel = _RANDOM_86[3:2];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_op2_sel = _RANDOM_86[6:4];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_imm_sel = _RANDOM_86[9:7];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_op_fcn = _RANDOM_86[13:10];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_fcn_dw = _RANDOM_86[14];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ctrl_csr_cmd = _RANDOM_86[17:15];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_is_br = _RANDOM_86[25];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_is_jalr = _RANDOM_86[26];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_is_jal = _RANDOM_86[27];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_is_sfb = _RANDOM_86[28];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_br_mask = {_RANDOM_86[31:29], _RANDOM_87[12:0]};	// @[register-read.scala:86:29]
        rrd_uops_2_REG_br_tag = _RANDOM_87[16:13];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ftq_idx = _RANDOM_87[22:17];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_edge_inst = _RANDOM_87[23];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_pc_lob = _RANDOM_87[29:24];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_taken = _RANDOM_87[30];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_imm_packed = {_RANDOM_87[31], _RANDOM_88[18:0]};	// @[register-read.scala:86:29]
        rrd_uops_2_REG_rob_idx = {_RANDOM_88[31], _RANDOM_89[6:0]};	// @[register-read.scala:86:29]
        rrd_uops_2_REG_ldq_idx = _RANDOM_89[11:7];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_stq_idx = _RANDOM_89[16:12];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_pdst = _RANDOM_89[24:19];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_prs1 = _RANDOM_89[30:25];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_prs2 = {_RANDOM_89[31], _RANDOM_90[4:0]};	// @[register-read.scala:86:29]
        rrd_uops_2_REG_bypassable = _RANDOM_92[28];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_is_amo = _RANDOM_93[7];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_uses_stq = _RANDOM_93[9];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_dst_rtype = _RANDOM_94[8:7];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_lrs1_rtype = _RANDOM_94[10:9];	// @[register-read.scala:86:29]
        rrd_uops_2_REG_lrs2_rtype = _RANDOM_94[12:11];	// @[register-read.scala:86:29]
        rrd_rs1_data_0_REG = _RANDOM_94[25];	// @[register-read.scala:86:29, :124:57]
        rrd_rs2_data_0_REG = _RANDOM_94[26];	// @[register-read.scala:86:29, :125:57]
        rrd_rs1_data_1_REG = _RANDOM_94[27];	// @[register-read.scala:86:29, :124:57]
        rrd_rs2_data_1_REG = _RANDOM_94[28];	// @[register-read.scala:86:29, :125:57]
        rrd_rs1_data_2_REG = _RANDOM_94[29];	// @[register-read.scala:86:29, :124:57]
        rrd_rs2_data_2_REG = _RANDOM_94[30];	// @[register-read.scala:86:29, :125:57]
      `endif // RANDOMIZE_REG_INIT
    end // initial
