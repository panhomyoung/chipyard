...
module FPUExeUnit(
  ...
  output [7:0]  io_fresp_bits_uop_rob_idx,
  ...
  output [7:0]  io_fresp_bits_fflags_bits_uop_rob_idx,
  ...
  output [7:0]  io_ll_iresp_bits_uop_rob_idx,
  ...
  wire [7:0]  _resp_arb_io_out_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:554:26]
  ...
  wire [7:0]  _fp_sdq_io_deq_bits_uop_rob_idx;	// @[execution-unit.scala:542:24]
  wire [4:0]  _fp_sdq_io_deq_bits_uop_stq_idx;	// @[execution-unit.scala:542:24]
  wire [5:0]  _fp_sdq_io_deq_bits_uop_pdst;	// @[execution-unit.scala:542:24]
  ...
  wire [7:0]  _fp_sdq_io_deq_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:542:24]
  ...
  wire [7:0]  _queue_io_deq_bits_uop_rob_idx;	// @[execution-unit.scala:528:23]
  wire [4:0]  _queue_io_deq_bits_uop_stq_idx;	// @[execution-unit.scala:528:23]
  wire [5:0]  _queue_io_deq_bits_uop_pdst;	// @[execution-unit.scala:528:23]
  ...
  wire [7:0]  _queue_io_deq_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:528:23]
  ...
  wire [7:0]  _fdivsqrt_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:493:22]
  wire [5:0]  _fdivsqrt_io_resp_bits_uop_pdst;	// @[execution-unit.scala:493:22]
  ...
  wire [7:0]  _fdivsqrt_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:493:22]
  ...
  wire [7:0]  _fpu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [5:0]  _fpu_io_resp_bits_uop_pdst;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_uop_prs1;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_uop_prs2;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_uop_prs3;	// @[execution-unit.scala:468:17]
  ...
  wire [5:0]  _fpu_io_resp_bits_uop_stale_pdst;	// @[execution-unit.scala:468:17]
  ...
  wire [7:0]  _fpu_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:468:17]
  ...
  wire [5:0]  _fpu_io_resp_bits_fflags_bits_uop_pdst;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_fflags_bits_uop_prs1;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_fflags_bits_uop_prs2;	// @[execution-unit.scala:468:17]
  wire [5:0]  _fpu_io_resp_bits_fflags_bits_uop_prs3;	// @[execution-unit.scala:468:17]
  ...
  wire [5:0]  _fpu_io_resp_bits_fflags_bits_uop_stale_pdst;	// @[execution-unit.scala:468:17]
  ...
  wire        _fp_sdq_io_enq_valid_T_5 = io_req_valid & io_req_bits_uop_uopc == 7'h2 & (io_brupdate_b1_mispredict_mask & io_req_bits_uop_br_mask) == 16'h0;	// @[execution-unit.scala:532:60, :544:{70,81}, util.scala:118:{51,59}]
  ...
  Arbiter_16 resp_arb (	// @[execution-unit.scala:554:26]
