...
module lb_combMem(	// @[mshrs.scala:568:15]
  input  [4:0]   R0_addr,
  input          R0_en,
                 R0_clk,
  input  [4:0]   W0_addr,
    ...
    initial begin	// @[mshrs.scala:568:15]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[mshrs.scala:568:15]
        for (initvar = 0; initvar < 32; initvar = initvar + 1) begin
          ...
          Memory[initvar] = _RANDOM_MEM[127:0];
        end	// @[mshrs.scala:568:15]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 128'bx;	// @[mshrs.scala:568:15]
endmodule
