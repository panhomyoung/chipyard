...
module BoomWritebackUnit(
  ...
  wire [3:0][127:0] _GEN = {{wb_buffer_3}, {wb_buffer_2}, {wb_buffer_1}, {wb_buffer_0}};	// @[Edges.scala:428:15, dcache.scala:46:22]
  wire              _io_req_ready_output = state == 3'h0;	// @[dcache.scala:39:22, :80:15]
  wire              _T_3 = state == 3'h1;	// @[dcache.scala:39:22, :83:13, :88:22]
  wire              _io_data_req_valid_output = ~_io_req_ready_output & _T_3 & ~(data_req_cnt[2]);	// @[dcache.scala:44:29, :54:22, :80:{15,30}, :88:{22,41}, :89:40]
  wire              _T_8 = r2_data_req_cnt == 3'h3;	// @[dcache.scala:43:28, :110:29, :120:12]
  ...
  wire              _io_release_valid_output = ~(_io_req_ready_output | _GEN_0) & _T_11 & ~(data_req_cnt[2]);	// @[dcache.scala:44:29, :51:22, :80:{15,30}, :88:41, :89:40, :116:41, :122:{22,36}, :123:38]
  wire              _T_14 = io_release_ready & _io_release_valid_output;	// @[Decoupled.scala:51:35, dcache.scala:51:22, :80:30, :88:41, :116:41, :122:36]
  wire              _T_16 = state == 3'h4;	// @[dcache.scala:39:22, :89:40, :135:22]
  ...
  always @(posedge clock) begin
    ...
    if (_GEN_1) begin	// @[dcache.scala:41:34, :80:30, :88:41]
      ...
      if (_T_6)	// @[dcache.scala:103:28]
        ...
        r1_data_req_cnt <= 3'h0;	// @[dcache.scala:39:22, :42:28]
      r2_data_req_cnt <= r1_data_req_cnt;	// @[dcache.scala:42:28, :43:28]
    end
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & r2_data_req_cnt[1:0] == 2'h0)) begin	// @[dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
      wb_buffer_0 <= io_data_resp;	// @[dcache.scala:46:22]
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & r2_data_req_cnt[1:0] == 2'h1)) begin	// @[dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
      wb_buffer_1 <= io_data_resp;	// @[dcache.scala:46:22]
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & r2_data_req_cnt[1:0] == 2'h2)) begin	// @[dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
      wb_buffer_2 <= io_data_resp;	// @[dcache.scala:46:22]
    if (_io_req_ready_output | ~(_T_3 & r2_data_req_fired & (&(r2_data_req_cnt[1:0])))) begin	// @[dcache.scala:41:34, :43:28, :46:22, :80:{15,30}, :88:{22,41}, :108:30, :109:34]
    end
    else	// @[dcache.scala:46:22, :80:30, :88:41]
    ...
    if (reset) begin
      ...
      data_req_cnt <= 3'h0;	// @[dcache.scala:39:22, :44:29]
      ...
      if (_io_req_ready_output) begin	// @[dcache.scala:80:15]
        ...
        if (_T_3) begin	// @[dcache.scala:88:22]
          if (r2_data_req_fired & _T_8) begin	// @[dcache.scala:39:22, :41:34, :108:30, :110:{29,53}, :112:15]
            ...
            data_req_cnt <= data_req_cnt + 3'h1;	// @[dcache.scala:44:29, :83:13, :106:36]
        end
          ...
          if (_T_9) begin	// @[dcache.scala:116:22]
            ...
            if (data_req_cnt == 3'h3 & _T_14)	// @[Decoupled.scala:51:35, dcache.scala:44:29, :120:12, :132:{25,49}]
              state <= {req_voluntary, 2'h0};	// @[dcache.scala:37:16, :39:22, :109:34, :133:19]
          end
          ...
          if (_T_9 | ~(_T_11 & _T_14)) begin	// @[Decoupled.scala:51:35, dcache.scala:44:29, :116:{22,41}, :122:{22,36}, :129:28, :130:20]
            ...
            data_req_cnt <= data_req_cnt + 3'h1;	// @[dcache.scala:44:29, :83:13, :130:36]
        end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_param = {_RANDOM_0[31:30], _RANDOM_1[0]};	// @[dcache.scala:37:16]
        req_way_en = _RANDOM_1[8:1];	// @[dcache.scala:37:16]
        req_voluntary = _RANDOM_1[9];	// @[dcache.scala:37:16]
        state = _RANDOM_1[12:10];	// @[dcache.scala:37:16, :39:22]
        r1_data_req_fired = _RANDOM_1[13];	// @[dcache.scala:37:16, :40:34]
        r2_data_req_fired = _RANDOM_1[14];	// @[dcache.scala:37:16, :41:34]
        r1_data_req_cnt = _RANDOM_1[17:15];	// @[dcache.scala:37:16, :42:28]
        r2_data_req_cnt = _RANDOM_1[20:18];	// @[dcache.scala:37:16, :43:28]
        data_req_cnt = _RANDOM_1[23:21];	// @[dcache.scala:37:16, :44:29]
        wb_buffer_0 = {_RANDOM_2, _RANDOM_3, _RANDOM_4, _RANDOM_5};	// @[dcache.scala:46:22]
        wb_buffer_1 = {_RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9};	// @[dcache.scala:46:22]
        wb_buffer_2 = {_RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13};	// @[dcache.scala:46:22]
        wb_buffer_3 = {_RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17};	// @[dcache.scala:46:22]
        acked = _RANDOM_18[0];	// @[dcache.scala:47:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_data_req_bits_addr = {req_idx, data_req_cnt[1:0], 4'h0};	// @[dcache.scala:37:16, :44:29, :97:43]
  ...
  assign io_release_bits_data = _GEN[data_req_cnt[1:0]];	// @[Edges.scala:428:15, dcache.scala:44:29]
