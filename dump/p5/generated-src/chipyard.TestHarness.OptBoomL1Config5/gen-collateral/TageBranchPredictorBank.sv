...
module TageBranchPredictorBank(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_48 = `RANDOM;
        _RANDOM_49 = `RANDOM;
        s1_update_valid = _RANDOM_5[3];	// @[predictor.scala:184:30]
        s1_update_bits_is_mispredict_update = _RANDOM_5[4];	// @[predictor.scala:184:30]
        s1_update_bits_is_repair_update = _RANDOM_5[5];	// @[predictor.scala:184:30]
        s1_update_bits_btb_mispredicts = _RANDOM_5[9:6];	// @[predictor.scala:184:30]
        s1_update_bits_pc = {_RANDOM_5[31:10], _RANDOM_6[17:0]};	// @[predictor.scala:184:30]
        ...
        s1_update_bits_cfi_mispredicted = _RANDOM_6[26];	// @[predictor.scala:184:30]
        s1_update_bits_ghist = {_RANDOM_6[31:30], _RANDOM_7, _RANDOM_8[29:0]};	// @[predictor.scala:184:30]
        s1_update_bits_meta = {_RANDOM_10[31:7], _RANDOM_11, _RANDOM_12, _RANDOM_13[30:0]};	// @[predictor.scala:184:30]
        t_io_f1_req_valid_REG = _RANDOM_15[4];	// @[tage.scala:225:35]
        t_io_f1_req_pc_REG = {_RANDOM_15[31:5], _RANDOM_16[12:0]};	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_valid_REG_1 = _RANDOM_16[13];	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_pc_REG_1 = {_RANDOM_16[31:14], _RANDOM_17[21:0]};	// @[tage.scala:226:35]
        t_io_f1_req_valid_REG_2 = _RANDOM_17[22];	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_pc_REG_2 = {_RANDOM_17[31:23], _RANDOM_18[30:0]};	// @[tage.scala:226:35]
        t_io_f1_req_valid_REG_3 = _RANDOM_18[31];	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_pc_REG_3 = {_RANDOM_19, _RANDOM_20[7:0]};	// @[tage.scala:226:35]
        t_io_f1_req_valid_REG_4 = _RANDOM_20[8];	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_pc_REG_4 = {_RANDOM_20[31:9], _RANDOM_21[16:0]};	// @[tage.scala:226:35]
        t_io_f1_req_valid_REG_5 = _RANDOM_21[17];	// @[tage.scala:225:35, :226:35]
        t_io_f1_req_pc_REG_5 = {_RANDOM_21[31:18], _RANDOM_22[25:0]};	// @[tage.scala:226:35]
        t_io_update_mask_0_REG = _RANDOM_22[26];	// @[tage.scala:226:35, :345:48]
        t_io_update_taken_0_REG = _RANDOM_22[27];	// @[tage.scala:226:35, :346:48]
        t_io_update_alloc_0_REG = _RANDOM_22[28];	// @[tage.scala:226:35, :347:48]
        t_io_update_old_ctr_0_REG = _RANDOM_22[31:29];	// @[tage.scala:226:35, :348:48]
        t_io_update_u_mask_0_REG = _RANDOM_23[0];	// @[tage.scala:350:47]
        t_io_update_u_0_REG = _RANDOM_23[2:1];	// @[tage.scala:350:47, :351:47]
        t_io_update_mask_1_REG = _RANDOM_23[3];	// @[tage.scala:345:48, :350:47]
        t_io_update_taken_1_REG = _RANDOM_23[4];	// @[tage.scala:346:48, :350:47]
        t_io_update_alloc_1_REG = _RANDOM_23[5];	// @[tage.scala:347:48, :350:47]
        t_io_update_old_ctr_1_REG = _RANDOM_23[8:6];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_mask_1_REG = _RANDOM_23[9];	// @[tage.scala:350:47]
        t_io_update_u_1_REG = _RANDOM_23[11:10];	// @[tage.scala:350:47, :351:47]
        t_io_update_mask_2_REG = _RANDOM_23[12];	// @[tage.scala:345:48, :350:47]
        t_io_update_taken_2_REG = _RANDOM_23[13];	// @[tage.scala:346:48, :350:47]
        t_io_update_alloc_2_REG = _RANDOM_23[14];	// @[tage.scala:347:48, :350:47]
        t_io_update_old_ctr_2_REG = _RANDOM_23[17:15];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_mask_2_REG = _RANDOM_23[18];	// @[tage.scala:350:47]
        t_io_update_u_2_REG = _RANDOM_23[20:19];	// @[tage.scala:350:47, :351:47]
        t_io_update_mask_3_REG = _RANDOM_23[21];	// @[tage.scala:345:48, :350:47]
        t_io_update_taken_3_REG = _RANDOM_23[22];	// @[tage.scala:346:48, :350:47]
        t_io_update_alloc_3_REG = _RANDOM_23[23];	// @[tage.scala:347:48, :350:47]
        t_io_update_old_ctr_3_REG = _RANDOM_23[26:24];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_mask_3_REG = _RANDOM_23[27];	// @[tage.scala:350:47]
        t_io_update_u_3_REG = _RANDOM_23[29:28];	// @[tage.scala:350:47, :351:47]
        t_io_update_pc_REG = {_RANDOM_23[31:30], _RANDOM_24, _RANDOM_25[5:0]};	// @[tage.scala:350:47, :353:41]
        t_io_update_hist_REG = {_RANDOM_25[31:6], _RANDOM_26, _RANDOM_27[5:0]};	// @[tage.scala:353:41, :354:41]
        t_io_update_mask_0_REG_1 = _RANDOM_27[6];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_0_REG_1 = _RANDOM_27[7];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_0_REG_1 = _RANDOM_27[8];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_0_REG_1 = _RANDOM_27[11:9];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_0_REG_1 = _RANDOM_27[12];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_0_REG_1 = _RANDOM_27[14:13];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_1_REG_1 = _RANDOM_27[15];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_1_REG_1 = _RANDOM_27[16];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_1_REG_1 = _RANDOM_27[17];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_1_REG_1 = _RANDOM_27[20:18];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_1_REG_1 = _RANDOM_27[21];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_1_REG_1 = _RANDOM_27[23:22];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_2_REG_1 = _RANDOM_27[24];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_2_REG_1 = _RANDOM_27[25];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_2_REG_1 = _RANDOM_27[26];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_2_REG_1 = _RANDOM_27[29:27];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_2_REG_1 = _RANDOM_27[30];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_2_REG_1 = {_RANDOM_27[31], _RANDOM_28[0]};	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_3_REG_1 = _RANDOM_28[1];	// @[tage.scala:345:48, :351:47]
        t_io_update_taken_3_REG_1 = _RANDOM_28[2];	// @[tage.scala:346:48, :351:47]
        t_io_update_alloc_3_REG_1 = _RANDOM_28[3];	// @[tage.scala:347:48, :351:47]
        t_io_update_old_ctr_3_REG_1 = _RANDOM_28[6:4];	// @[tage.scala:348:48, :351:47]
        t_io_update_u_mask_3_REG_1 = _RANDOM_28[7];	// @[tage.scala:350:47, :351:47]
        t_io_update_u_3_REG_1 = _RANDOM_28[9:8];	// @[tage.scala:351:47]
        t_io_update_pc_REG_1 = {_RANDOM_28[31:10], _RANDOM_29[17:0]};	// @[tage.scala:351:47, :353:41]
        t_io_update_hist_REG_1 = {_RANDOM_29[31:18], _RANDOM_30, _RANDOM_31[17:0]};	// @[tage.scala:353:41, :354:41]
        t_io_update_mask_0_REG_2 = _RANDOM_31[18];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_0_REG_2 = _RANDOM_31[19];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_0_REG_2 = _RANDOM_31[20];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_0_REG_2 = _RANDOM_31[23:21];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_0_REG_2 = _RANDOM_31[24];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_0_REG_2 = _RANDOM_31[26:25];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_1_REG_2 = _RANDOM_31[27];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_1_REG_2 = _RANDOM_31[28];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_1_REG_2 = _RANDOM_31[29];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_1_REG_2 = {_RANDOM_31[31:30], _RANDOM_32[0]};	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_1_REG_2 = _RANDOM_32[1];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_1_REG_2 = _RANDOM_32[3:2];	// @[tage.scala:348:48, :351:47]
        t_io_update_mask_2_REG_2 = _RANDOM_32[4];	// @[tage.scala:345:48, :348:48]
        t_io_update_taken_2_REG_2 = _RANDOM_32[5];	// @[tage.scala:346:48, :348:48]
        t_io_update_alloc_2_REG_2 = _RANDOM_32[6];	// @[tage.scala:347:48, :348:48]
        t_io_update_old_ctr_2_REG_2 = _RANDOM_32[9:7];	// @[tage.scala:348:48]
        t_io_update_u_mask_2_REG_2 = _RANDOM_32[10];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_2_REG_2 = _RANDOM_32[12:11];	// @[tage.scala:348:48, :351:47]
        t_io_update_mask_3_REG_2 = _RANDOM_32[13];	// @[tage.scala:345:48, :348:48]
        t_io_update_taken_3_REG_2 = _RANDOM_32[14];	// @[tage.scala:346:48, :348:48]
        t_io_update_alloc_3_REG_2 = _RANDOM_32[15];	// @[tage.scala:347:48, :348:48]
        t_io_update_old_ctr_3_REG_2 = _RANDOM_32[18:16];	// @[tage.scala:348:48]
        t_io_update_u_mask_3_REG_2 = _RANDOM_32[19];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_3_REG_2 = _RANDOM_32[21:20];	// @[tage.scala:348:48, :351:47]
        t_io_update_pc_REG_2 = {_RANDOM_32[31:22], _RANDOM_33[29:0]};	// @[tage.scala:348:48, :353:41]
        t_io_update_hist_REG_2 = {_RANDOM_33[31:30], _RANDOM_34, _RANDOM_35[29:0]};	// @[tage.scala:353:41, :354:41]
        t_io_update_mask_0_REG_3 = _RANDOM_35[30];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_0_REG_3 = _RANDOM_35[31];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_0_REG_3 = _RANDOM_36[0];	// @[tage.scala:347:48]
        t_io_update_old_ctr_0_REG_3 = _RANDOM_36[3:1];	// @[tage.scala:347:48, :348:48]
        t_io_update_u_mask_0_REG_3 = _RANDOM_36[4];	// @[tage.scala:347:48, :350:47]
        t_io_update_u_0_REG_3 = _RANDOM_36[6:5];	// @[tage.scala:347:48, :351:47]
        t_io_update_mask_1_REG_3 = _RANDOM_36[7];	// @[tage.scala:345:48, :347:48]
        t_io_update_taken_1_REG_3 = _RANDOM_36[8];	// @[tage.scala:346:48, :347:48]
        t_io_update_alloc_1_REG_3 = _RANDOM_36[9];	// @[tage.scala:347:48]
        t_io_update_old_ctr_1_REG_3 = _RANDOM_36[12:10];	// @[tage.scala:347:48, :348:48]
        t_io_update_u_mask_1_REG_3 = _RANDOM_36[13];	// @[tage.scala:347:48, :350:47]
        t_io_update_u_1_REG_3 = _RANDOM_36[15:14];	// @[tage.scala:347:48, :351:47]
        t_io_update_mask_2_REG_3 = _RANDOM_36[16];	// @[tage.scala:345:48, :347:48]
        t_io_update_taken_2_REG_3 = _RANDOM_36[17];	// @[tage.scala:346:48, :347:48]
        t_io_update_alloc_2_REG_3 = _RANDOM_36[18];	// @[tage.scala:347:48]
        t_io_update_old_ctr_2_REG_3 = _RANDOM_36[21:19];	// @[tage.scala:347:48, :348:48]
        t_io_update_u_mask_2_REG_3 = _RANDOM_36[22];	// @[tage.scala:347:48, :350:47]
        t_io_update_u_2_REG_3 = _RANDOM_36[24:23];	// @[tage.scala:347:48, :351:47]
        t_io_update_mask_3_REG_3 = _RANDOM_36[25];	// @[tage.scala:345:48, :347:48]
        t_io_update_taken_3_REG_3 = _RANDOM_36[26];	// @[tage.scala:346:48, :347:48]
        t_io_update_alloc_3_REG_3 = _RANDOM_36[27];	// @[tage.scala:347:48]
        t_io_update_old_ctr_3_REG_3 = _RANDOM_36[30:28];	// @[tage.scala:347:48, :348:48]
        t_io_update_u_mask_3_REG_3 = _RANDOM_36[31];	// @[tage.scala:347:48, :350:47]
        t_io_update_u_3_REG_3 = _RANDOM_37[1:0];	// @[tage.scala:351:47]
        t_io_update_pc_REG_3 = {_RANDOM_37[31:2], _RANDOM_38[9:0]};	// @[tage.scala:351:47, :353:41]
        t_io_update_hist_REG_3 = {_RANDOM_38[31:10], _RANDOM_39, _RANDOM_40[9:0]};	// @[tage.scala:353:41, :354:41]
        t_io_update_mask_0_REG_4 = _RANDOM_40[10];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_0_REG_4 = _RANDOM_40[11];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_0_REG_4 = _RANDOM_40[12];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_0_REG_4 = _RANDOM_40[15:13];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_0_REG_4 = _RANDOM_40[16];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_0_REG_4 = _RANDOM_40[18:17];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_1_REG_4 = _RANDOM_40[19];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_1_REG_4 = _RANDOM_40[20];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_1_REG_4 = _RANDOM_40[21];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_1_REG_4 = _RANDOM_40[24:22];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_1_REG_4 = _RANDOM_40[25];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_1_REG_4 = _RANDOM_40[27:26];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_2_REG_4 = _RANDOM_40[28];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_2_REG_4 = _RANDOM_40[29];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_2_REG_4 = _RANDOM_40[30];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_2_REG_4 = {_RANDOM_40[31], _RANDOM_41[1:0]};	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_2_REG_4 = _RANDOM_41[2];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_2_REG_4 = _RANDOM_41[4:3];	// @[tage.scala:348:48, :351:47]
        t_io_update_mask_3_REG_4 = _RANDOM_41[5];	// @[tage.scala:345:48, :348:48]
        t_io_update_taken_3_REG_4 = _RANDOM_41[6];	// @[tage.scala:346:48, :348:48]
        t_io_update_alloc_3_REG_4 = _RANDOM_41[7];	// @[tage.scala:347:48, :348:48]
        t_io_update_old_ctr_3_REG_4 = _RANDOM_41[10:8];	// @[tage.scala:348:48]
        t_io_update_u_mask_3_REG_4 = _RANDOM_41[11];	// @[tage.scala:348:48, :350:47]
        t_io_update_u_3_REG_4 = _RANDOM_41[13:12];	// @[tage.scala:348:48, :351:47]
        t_io_update_pc_REG_4 = {_RANDOM_41[31:14], _RANDOM_42[21:0]};	// @[tage.scala:348:48, :353:41]
        t_io_update_hist_REG_4 = {_RANDOM_42[31:22], _RANDOM_43, _RANDOM_44[21:0]};	// @[tage.scala:353:41, :354:41]
        t_io_update_mask_0_REG_5 = _RANDOM_44[22];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_0_REG_5 = _RANDOM_44[23];	// @[tage.scala:346:48, :354:41]
        t_io_update_alloc_0_REG_5 = _RANDOM_44[24];	// @[tage.scala:347:48, :354:41]
        t_io_update_old_ctr_0_REG_5 = _RANDOM_44[27:25];	// @[tage.scala:348:48, :354:41]
        t_io_update_u_mask_0_REG_5 = _RANDOM_44[28];	// @[tage.scala:350:47, :354:41]
        t_io_update_u_0_REG_5 = _RANDOM_44[30:29];	// @[tage.scala:351:47, :354:41]
        t_io_update_mask_1_REG_5 = _RANDOM_44[31];	// @[tage.scala:345:48, :354:41]
        t_io_update_taken_1_REG_5 = _RANDOM_45[0];	// @[tage.scala:346:48]
        t_io_update_alloc_1_REG_5 = _RANDOM_45[1];	// @[tage.scala:346:48, :347:48]
        t_io_update_old_ctr_1_REG_5 = _RANDOM_45[4:2];	// @[tage.scala:346:48, :348:48]
        t_io_update_u_mask_1_REG_5 = _RANDOM_45[5];	// @[tage.scala:346:48, :350:47]
        t_io_update_u_1_REG_5 = _RANDOM_45[7:6];	// @[tage.scala:346:48, :351:47]
        t_io_update_mask_2_REG_5 = _RANDOM_45[8];	// @[tage.scala:345:48, :346:48]
        t_io_update_taken_2_REG_5 = _RANDOM_45[9];	// @[tage.scala:346:48]
        t_io_update_alloc_2_REG_5 = _RANDOM_45[10];	// @[tage.scala:346:48, :347:48]
        t_io_update_old_ctr_2_REG_5 = _RANDOM_45[13:11];	// @[tage.scala:346:48, :348:48]
        t_io_update_u_mask_2_REG_5 = _RANDOM_45[14];	// @[tage.scala:346:48, :350:47]
        t_io_update_u_2_REG_5 = _RANDOM_45[16:15];	// @[tage.scala:346:48, :351:47]
        t_io_update_mask_3_REG_5 = _RANDOM_45[17];	// @[tage.scala:345:48, :346:48]
        t_io_update_taken_3_REG_5 = _RANDOM_45[18];	// @[tage.scala:346:48]
        t_io_update_alloc_3_REG_5 = _RANDOM_45[19];	// @[tage.scala:346:48, :347:48]
        t_io_update_old_ctr_3_REG_5 = _RANDOM_45[22:20];	// @[tage.scala:346:48, :348:48]
        t_io_update_u_mask_3_REG_5 = _RANDOM_45[23];	// @[tage.scala:346:48, :350:47]
        t_io_update_u_3_REG_5 = _RANDOM_45[25:24];	// @[tage.scala:346:48, :351:47]
        t_io_update_pc_REG_5 = {_RANDOM_45[31:26], _RANDOM_46, _RANDOM_47[1:0]};	// @[tage.scala:346:48, :353:41]
        t_io_update_hist_REG_5 = {_RANDOM_47[31:2], _RANDOM_48, _RANDOM_49[1:0]};	// @[tage.scala:353:41, :354:41]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MaxPeriodFibonacciLFSR_2 alloc_lfsr_prng (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_2 alloc_lfsr_prng_1 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_2 alloc_lfsr_prng_2 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
  ...
  MaxPeriodFibonacciLFSR_2 alloc_lfsr_prng_3 (	// @[PRNG.scala:91:22]
    .clock    (clock),
    .reset    (reset),
