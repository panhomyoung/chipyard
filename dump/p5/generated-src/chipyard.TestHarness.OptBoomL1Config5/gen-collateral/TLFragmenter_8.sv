...
module TLFragmenter_8(
  ...
  wire [3:0]  _repeater_io_deq_bits_source;	// @[Fragmenter.scala:263:30]
  wire [28:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:263:30]
  ...
  wire [2:0]  _GEN_0 = {1'h0, _GEN[5:4]} | _GEN[2:0];	// @[Fragmenter.scala:191:24, OneHot.scala:31:18, :32:28, package.scala:233:47]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      dToggle <= 1'h0;	// @[Fragmenter.scala:191:24, :192:30]
  ...
  TLMonitor_64 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[7:4]),	// @[Fragmenter.scala:227:47]
    .io_in_d_bits_sink    (auto_out_d_bits_sink),
    .io_in_d_bits_denied  (auto_out_d_bits_denied),
    .io_in_d_bits_corrupt (auto_out_d_bits_corrupt)
  );
  Repeater_12 repeater (	// @[Fragmenter.scala:263:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_in_d_bits_source = auto_out_d_bits_source[7:4];	// @[Fragmenter.scala:227:47]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {23'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}]
