  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_valid = _RANDOM_3[13];	// @[predictor.scala:168:25, :169:25]
        ...
        s1_update_bits_cfi_is_br = _RANDOM_6[27];	// @[predictor.scala:184:30]
        ...
        doing_reset = _RANDOM_15[4];	// @[bim.scala:44:28, predictor.scala:185:30]
        reset_idx = _RANDOM_15[15:5];	// @[bim.scala:45:26, predictor.scala:185:30]
        s2_req_rdata_0 = _RANDOM_15[17:16];	// @[bim.scala:54:32, predictor.scala:185:30]
        s2_req_rdata_1 = _RANDOM_15[19:18];	// @[bim.scala:54:32, predictor.scala:185:30]
        s2_req_rdata_2 = _RANDOM_15[21:20];	// @[bim.scala:54:32, predictor.scala:185:30]
        s2_req_rdata_3 = _RANDOM_15[23:22];	// @[bim.scala:54:32, predictor.scala:185:30]
        wrbypass_idxs_0 = {_RANDOM_15[31:24], _RANDOM_16[2:0]};	// @[bim.scala:70:26, predictor.scala:185:30]
        wrbypass_idxs_1 = _RANDOM_16[13:3];	// @[bim.scala:70:26]
        wrbypass_0_0 = _RANDOM_16[15:14];	// @[bim.scala:70:26, :71:26]
        wrbypass_0_1 = _RANDOM_16[17:16];	// @[bim.scala:70:26, :71:26]
        wrbypass_0_2 = _RANDOM_16[19:18];	// @[bim.scala:70:26, :71:26]
        wrbypass_0_3 = _RANDOM_16[21:20];	// @[bim.scala:70:26, :71:26]
        wrbypass_1_0 = _RANDOM_16[23:22];	// @[bim.scala:70:26, :71:26]
        wrbypass_1_1 = _RANDOM_16[25:24];	// @[bim.scala:70:26, :71:26]
        wrbypass_1_2 = _RANDOM_16[27:26];	// @[bim.scala:70:26, :71:26]
        wrbypass_1_3 = _RANDOM_16[29:28];	// @[bim.scala:70:26, :71:26]
        wrbypass_enq_idx = _RANDOM_16[30];	// @[bim.scala:70:26, :72:33]
        io_resp_f3_0_taken_REG = _RANDOM_16[31];	// @[bim.scala:70:26, :128:35]
        io_resp_f3_1_taken_REG = _RANDOM_17[0];	// @[bim.scala:128:35]
        io_resp_f3_2_taken_REG = _RANDOM_17[1];	// @[bim.scala:128:35]
        io_resp_f3_3_taken_REG = _RANDOM_17[2];	// @[bim.scala:128:35]
        io_f3_meta_REG = _RANDOM_17[10:3];	// @[bim.scala:128:35, :130:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
