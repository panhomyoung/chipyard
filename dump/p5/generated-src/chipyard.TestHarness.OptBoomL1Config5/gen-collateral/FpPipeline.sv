...
module FpPipeline(
  ...
  input  [7:0]  io_dis_uops_0_bits_rob_idx,
  ...
  input  [7:0]  io_dis_uops_1_bits_rob_idx,
  ...
  input  [5:0]  io_dis_uops_2_bits_stale_pdst,
  ...
  input  [15:0] io_dis_uops_3_bits_br_mask,
  input  [3:0]  io_dis_uops_3_bits_br_tag,
  ...
  input  [5:0]  io_dis_uops_3_bits_stale_pdst,
  ...
  input         io_dis_uops_4_valid,
  input  [6:0]  io_dis_uops_4_bits_uopc,
  input  [31:0] io_dis_uops_4_bits_inst,
                io_dis_uops_4_bits_debug_inst,
  input         io_dis_uops_4_bits_is_rvc,
  input  [39:0] io_dis_uops_4_bits_debug_pc,
  input  [2:0]  io_dis_uops_4_bits_iq_type,
  input  [9:0]  io_dis_uops_4_bits_fu_code,
  input         io_dis_uops_4_bits_is_br,
                io_dis_uops_4_bits_is_jalr,
                io_dis_uops_4_bits_is_jal,
                io_dis_uops_4_bits_is_sfb,
  input  [15:0] io_dis_uops_4_bits_br_mask,
  input  [3:0]  io_dis_uops_4_bits_br_tag,
  input  [5:0]  io_dis_uops_4_bits_ftq_idx,
  input         io_dis_uops_4_bits_edge_inst,
  input  [5:0]  io_dis_uops_4_bits_pc_lob,
  input         io_dis_uops_4_bits_taken,
  input  [19:0] io_dis_uops_4_bits_imm_packed,
  input  [11:0] io_dis_uops_4_bits_csr_addr,
  input  [7:0]  io_dis_uops_4_bits_rob_idx,
  input  [4:0]  io_dis_uops_4_bits_ldq_idx,
                io_dis_uops_4_bits_stq_idx,
  input  [1:0]  io_dis_uops_4_bits_rxq_idx,
  input  [5:0]  io_dis_uops_4_bits_pdst,
                io_dis_uops_4_bits_prs1,
                io_dis_uops_4_bits_prs2,
                io_dis_uops_4_bits_prs3,
  input         io_dis_uops_4_bits_prs1_busy,
                io_dis_uops_4_bits_prs2_busy,
                io_dis_uops_4_bits_prs3_busy,
  input  [5:0]  io_dis_uops_4_bits_stale_pdst,
  input         io_dis_uops_4_bits_exception,
  input  [63:0] io_dis_uops_4_bits_exc_cause,
  input         io_dis_uops_4_bits_bypassable,
  input  [4:0]  io_dis_uops_4_bits_mem_cmd,
  input  [1:0]  io_dis_uops_4_bits_mem_size,
  input         io_dis_uops_4_bits_mem_signed,
                io_dis_uops_4_bits_is_fence,
                io_dis_uops_4_bits_is_fencei,
                io_dis_uops_4_bits_is_amo,
                io_dis_uops_4_bits_uses_ldq,
                io_dis_uops_4_bits_uses_stq,
                io_dis_uops_4_bits_is_sys_pc2epc,
                io_dis_uops_4_bits_is_unique,
                io_dis_uops_4_bits_flush_on_commit,
                io_dis_uops_4_bits_ldst_is_rs1,
  input  [5:0]  io_dis_uops_4_bits_ldst,
                io_dis_uops_4_bits_lrs1,
                io_dis_uops_4_bits_lrs2,
                io_dis_uops_4_bits_lrs3,
  input         io_dis_uops_4_bits_ldst_val,
  input  [1:0]  io_dis_uops_4_bits_dst_rtype,
                io_dis_uops_4_bits_lrs1_rtype,
                io_dis_uops_4_bits_lrs2_rtype,
  input         io_dis_uops_4_bits_frs3_en,
                io_dis_uops_4_bits_fp_val,
                io_dis_uops_4_bits_fp_single,
                io_dis_uops_4_bits_xcpt_pf_if,
                io_dis_uops_4_bits_xcpt_ae_if,
                io_dis_uops_4_bits_xcpt_ma_if,
                io_dis_uops_4_bits_bp_debug_if,
                io_dis_uops_4_bits_bp_xcpt_if,
  input  [1:0]  io_dis_uops_4_bits_debug_fsrc,
                io_dis_uops_4_bits_debug_tsrc,
  input         io_ll_wports_0_valid,
  input  [6:0]  io_ll_wports_0_bits_uop_uopc,
  input  [15:0] io_ll_wports_0_bits_uop_br_mask,
  input  [7:0]  io_ll_wports_0_bits_uop_rob_idx,
  ...
  input  [7:0]  io_from_int_bits_uop_rob_idx,
  ...
  input  [7:0]  io_from_int_bits_fflags_bits_uop_rob_idx,
  ...
  output        io_to_int_bits_predicated,
                io_wakeups_0_valid,
  output [7:0]  io_wakeups_0_bits_uop_rob_idx,
  ...
  output [7:0]  io_wakeups_0_bits_fflags_bits_uop_rob_idx,
  output [4:0]  io_wakeups_0_bits_fflags_bits_flags,
  output        io_wakeups_1_valid,
  output [7:0]  io_wakeups_1_bits_uop_rob_idx,
  ...
  output [7:0]  io_wakeups_1_bits_fflags_bits_uop_rob_idx,
  ...
  wire [15:0]  _ll_wbarb_io_out_bits_uop_br_mask;	// @[fp-pipeline.scala:170:24]
  wire [4:0]   _ll_wbarb_io_out_bits_uop_stq_idx;	// @[fp-pipeline.scala:170:24]
  wire [5:0]   _ll_wbarb_io_out_bits_uop_pdst;	// @[fp-pipeline.scala:170:24]
  ...
  wire [5:0]   _fregister_read_io_rf_read_ports_0_addr;	// @[fp-pipeline.scala:73:30]
  wire [5:0]   _fregister_read_io_rf_read_ports_1_addr;	// @[fp-pipeline.scala:73:30]
  wire [5:0]   _fregister_read_io_rf_read_ports_2_addr;	// @[fp-pipeline.scala:73:30]
  ...
  wire [7:0]   _fregister_read_io_exe_reqs_0_bits_uop_rob_idx;	// @[fp-pipeline.scala:73:30]
  ...
  wire [5:0]   _fregister_read_io_exe_reqs_0_bits_uop_pdst;	// @[fp-pipeline.scala:73:30]
  wire [5:0]   _fregister_read_io_exe_reqs_0_bits_uop_prs1;	// @[fp-pipeline.scala:73:30]
  wire [5:0]   _fregister_read_io_exe_reqs_0_bits_uop_prs2;	// @[fp-pipeline.scala:73:30]
  wire [5:0]   _fregister_read_io_exe_reqs_0_bits_uop_prs3;	// @[fp-pipeline.scala:73:30]
  ...
  wire [5:0]   _fregister_read_io_exe_reqs_0_bits_uop_stale_pdst;	// @[fp-pipeline.scala:73:30]
  ...
  wire [7:0]   _fp_issue_unit_io_iss_uops_0_rob_idx;	// @[fp-pipeline.scala:62:30]
  ...
  wire [5:0]   _fp_issue_unit_io_iss_uops_0_pdst;	// @[fp-pipeline.scala:62:30]
  wire [5:0]   _fp_issue_unit_io_iss_uops_0_prs1;	// @[fp-pipeline.scala:62:30]
  wire [5:0]   _fp_issue_unit_io_iss_uops_0_prs2;	// @[fp-pipeline.scala:62:30]
  wire [5:0]   _fp_issue_unit_io_iss_uops_0_prs3;	// @[fp-pipeline.scala:62:30]
  ...
  wire [5:0]   _fp_issue_unit_io_iss_uops_0_stale_pdst;	// @[fp-pipeline.scala:62:30]
  ...
  wire [5:0]   _fpiu_unit_io_fresp_bits_uop_pdst;	// @[execution-units.scala:131:32]
  ...
  wire [7:0]   _fpiu_unit_io_ll_iresp_bits_uop_rob_idx;	// @[execution-units.scala:131:32]
  ...
  wire         ll_wbarb_io_in_0_bits_data_rawIn_isZeroExpIn = _GEN[62:52] == 11'h0;	// @[FPU.scala:425:23, rawFloatFromFN.scala:47:23, :50:34]
  ...
  IssueUnitCollapsing fp_issue_unit (	// @[fp-pipeline.scala:62:30]
    ...
    .io_dis_uops_4_valid                (io_dis_uops_4_valid),
    .io_dis_uops_4_bits_uopc            (io_dis_uops_4_bits_uopc),
    .io_dis_uops_4_bits_inst            (io_dis_uops_4_bits_inst),
    .io_dis_uops_4_bits_debug_inst      (io_dis_uops_4_bits_debug_inst),
    .io_dis_uops_4_bits_is_rvc          (io_dis_uops_4_bits_is_rvc),
    .io_dis_uops_4_bits_debug_pc        (io_dis_uops_4_bits_debug_pc),
    .io_dis_uops_4_bits_iq_type         (io_dis_uops_4_bits_iq_type),
    .io_dis_uops_4_bits_fu_code         (io_dis_uops_4_bits_fu_code),
    .io_dis_uops_4_bits_is_br           (io_dis_uops_4_bits_is_br),
    .io_dis_uops_4_bits_is_jalr         (io_dis_uops_4_bits_is_jalr),
    .io_dis_uops_4_bits_is_jal          (io_dis_uops_4_bits_is_jal),
    .io_dis_uops_4_bits_is_sfb          (io_dis_uops_4_bits_is_sfb),
    .io_dis_uops_4_bits_br_mask         (io_dis_uops_4_bits_br_mask),
    .io_dis_uops_4_bits_br_tag          (io_dis_uops_4_bits_br_tag),
    .io_dis_uops_4_bits_ftq_idx         (io_dis_uops_4_bits_ftq_idx),
    .io_dis_uops_4_bits_edge_inst       (io_dis_uops_4_bits_edge_inst),
    .io_dis_uops_4_bits_pc_lob          (io_dis_uops_4_bits_pc_lob),
    .io_dis_uops_4_bits_taken           (io_dis_uops_4_bits_taken),
    .io_dis_uops_4_bits_imm_packed      (io_dis_uops_4_bits_imm_packed),
    .io_dis_uops_4_bits_csr_addr        (io_dis_uops_4_bits_csr_addr),
    .io_dis_uops_4_bits_rob_idx         (io_dis_uops_4_bits_rob_idx),
    .io_dis_uops_4_bits_ldq_idx         (io_dis_uops_4_bits_ldq_idx),
    .io_dis_uops_4_bits_stq_idx         (io_dis_uops_4_bits_stq_idx),
    .io_dis_uops_4_bits_rxq_idx         (io_dis_uops_4_bits_rxq_idx),
    .io_dis_uops_4_bits_pdst            (io_dis_uops_4_bits_pdst),
    .io_dis_uops_4_bits_prs1            (io_dis_uops_4_bits_prs1),
    .io_dis_uops_4_bits_prs2            (io_dis_uops_4_bits_prs2),
    .io_dis_uops_4_bits_prs3            (io_dis_uops_4_bits_prs3),
    .io_dis_uops_4_bits_prs1_busy       (io_dis_uops_4_bits_prs1_busy),
    .io_dis_uops_4_bits_prs2_busy       (io_dis_uops_4_bits_prs2_busy),
    .io_dis_uops_4_bits_prs3_busy       (io_dis_uops_4_bits_prs3_busy),
    .io_dis_uops_4_bits_stale_pdst      (io_dis_uops_4_bits_stale_pdst),
    .io_dis_uops_4_bits_exception       (io_dis_uops_4_bits_exception),
    .io_dis_uops_4_bits_exc_cause       (io_dis_uops_4_bits_exc_cause),
    .io_dis_uops_4_bits_bypassable      (io_dis_uops_4_bits_bypassable),
    .io_dis_uops_4_bits_mem_cmd         (io_dis_uops_4_bits_mem_cmd),
    .io_dis_uops_4_bits_mem_size        (io_dis_uops_4_bits_mem_size),
    .io_dis_uops_4_bits_mem_signed      (io_dis_uops_4_bits_mem_signed),
    .io_dis_uops_4_bits_is_fence        (io_dis_uops_4_bits_is_fence),
    .io_dis_uops_4_bits_is_fencei       (io_dis_uops_4_bits_is_fencei),
    .io_dis_uops_4_bits_is_amo          (io_dis_uops_4_bits_is_amo),
    .io_dis_uops_4_bits_uses_ldq        (io_dis_uops_4_bits_uses_ldq),
    .io_dis_uops_4_bits_uses_stq        (io_dis_uops_4_bits_uses_stq),
    .io_dis_uops_4_bits_is_sys_pc2epc   (io_dis_uops_4_bits_is_sys_pc2epc),
    .io_dis_uops_4_bits_is_unique       (io_dis_uops_4_bits_is_unique),
    .io_dis_uops_4_bits_flush_on_commit (io_dis_uops_4_bits_flush_on_commit),
    .io_dis_uops_4_bits_ldst_is_rs1     (io_dis_uops_4_bits_ldst_is_rs1),
    .io_dis_uops_4_bits_ldst            (io_dis_uops_4_bits_ldst),
    .io_dis_uops_4_bits_lrs1            (io_dis_uops_4_bits_lrs1),
    .io_dis_uops_4_bits_lrs2            (io_dis_uops_4_bits_lrs2),
    .io_dis_uops_4_bits_lrs3            (io_dis_uops_4_bits_lrs3),
    .io_dis_uops_4_bits_ldst_val        (io_dis_uops_4_bits_ldst_val),
    .io_dis_uops_4_bits_dst_rtype       (io_dis_uops_4_bits_dst_rtype),
    .io_dis_uops_4_bits_lrs1_rtype      (io_dis_uops_4_bits_lrs1_rtype),
    .io_dis_uops_4_bits_lrs2_rtype      (io_dis_uops_4_bits_lrs2_rtype),
    .io_dis_uops_4_bits_frs3_en         (io_dis_uops_4_bits_frs3_en),
    .io_dis_uops_4_bits_fp_val          (io_dis_uops_4_bits_fp_val),
    .io_dis_uops_4_bits_fp_single       (io_dis_uops_4_bits_fp_single),
    .io_dis_uops_4_bits_xcpt_pf_if      (io_dis_uops_4_bits_xcpt_pf_if),
    .io_dis_uops_4_bits_xcpt_ae_if      (io_dis_uops_4_bits_xcpt_ae_if),
    .io_dis_uops_4_bits_xcpt_ma_if      (io_dis_uops_4_bits_xcpt_ma_if),
    .io_dis_uops_4_bits_bp_debug_if     (io_dis_uops_4_bits_bp_debug_if),
    .io_dis_uops_4_bits_bp_xcpt_if      (io_dis_uops_4_bits_bp_xcpt_if),
    .io_dis_uops_4_bits_debug_fsrc      (io_dis_uops_4_bits_debug_fsrc),
    .io_dis_uops_4_bits_debug_tsrc      (io_dis_uops_4_bits_debug_tsrc),
    ...
    .io_dis_uops_4_ready                (io_dis_uops_4_ready),
  ...
  Arbiter_16 ll_wbarb (	// @[fp-pipeline.scala:170:24]
    ...
    .io_in_0_bits_fflags_bits_uop_rob_idx (8'h0),
