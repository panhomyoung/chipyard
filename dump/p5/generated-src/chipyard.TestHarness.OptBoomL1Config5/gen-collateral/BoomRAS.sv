...
module BoomRAS(
  ...
  wire [31:0][39:0] _GEN = {{ras_0}, {ras_0}, {ras_0}, {ras_0}, {ras_0}, {ras_0}, {ras_0}, {ras_0}, {ras_23}, {ras_22}, {ras_21}, {ras_20}, {ras_19}, {ras_18}, {ras_17}, {ras_16}, {ras_15}, {ras_14}, {ras_13}, {ras_12}, {ras_11}, {ras_10}, {ras_9}, {ras_8}, {ras_7}, {ras_6}, {ras_5}, {ras_4}, {ras_3}, {ras_2}, {ras_1}, {ras_0}};	// @[ras.scala:36:16, :40:12]
  always @(posedge clock) begin
    if (io_write_valid & io_write_idx == 5'h0)	// @[ras.scala:36:16, :40:12, :42:25, :43:23]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_read_addr_REG = _RANDOM_30[0];	// @[ras.scala:38:30]
        io_read_addr_REG_1 = {_RANDOM_30[31:1], _RANDOM_31[8:0]};	// @[ras.scala:38:30, :39:12]
        io_read_addr_REG_2 = {_RANDOM_31[31:9], _RANDOM_32[16:0]};	// @[ras.scala:39:12, :40:12]
      `endif // RANDOMIZE_REG_INIT
    end // initial
