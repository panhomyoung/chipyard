...
module TLFragmenter_9(
  ...
  wire [17:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:263:30]
    ...
    if (reset) begin
      ...
      if (_T_7) begin	// @[Decoupled.scala:51:35]
        if (dFirst)	// @[Fragmenter.scala:194:29]
          ...
          acknum <= acknum - 3'h1;	// @[Fragmenter.scala:190:29, :210:55]
      end
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[Fragmenter.scala:313:16]
  ...
  Repeater_13 repeater (	// @[Fragmenter.scala:263:30]
    .clock               (clock),
    .reset               (reset),
    .io_repeat           (|old_gennum1),	// @[Fragmenter.scala:294:30, :303:53]
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {12'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}]
