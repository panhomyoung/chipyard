...
module TageTable_5(
  ...
  wire [51:0] _table_R0_data;	// @[tage.scala:91:27]
  ...
  wire [6:0]  _s2_req_rlous_T_1 = io_f1_req_pc[10:4] ^ io_f1_req_ghist[6:0] ^ io_f1_req_ghist[13:7] ^ io_f1_req_ghist[20:14] ^ io_f1_req_ghist[27:21] ^ io_f1_req_ghist[34:28] ^ io_f1_req_ghist[41:35] ^ io_f1_req_ghist[48:42] ^ io_f1_req_ghist[55:49] ^ io_f1_req_ghist[62:56] ^ {6'h0, io_f1_req_ghist[63]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :60:29]
  ...
  wire [6:0]  update_idx = io_update_pc[10:4] ^ io_update_hist[6:0] ^ io_update_hist[13:7] ^ io_update_hist[20:14] ^ io_update_hist[27:21] ^ io_update_hist[34:28] ^ io_update_hist[41:35] ^ io_update_hist[48:42] ^ io_update_hist[55:49] ^ io_update_hist[62:56] ^ {6'h0, io_update_hist[63]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :60:29]
  wire [8:0]  update_wdata_3_tag = io_update_pc[19:11] ^ io_update_hist[8:0] ^ io_update_hist[17:9] ^ io_update_hist[26:18] ^ io_update_hist[35:27] ^ io_update_hist[44:36] ^ io_update_hist[53:45] ^ io_update_hist[62:54] ^ {8'h0, io_update_hist[63]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}]
  assign table_MPORT_data_0 = doing_reset ? 13'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_0};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_1 = doing_reset ? 13'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_1};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_2 = doing_reset ? 13'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_2};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_3 = doing_reset ? 13'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_3};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      reset_idx <= reset_idx + {6'h0, doing_reset};	// @[tage.scala:55:25, :72:28, :73:26, :74:26]
    ...
    s2_tag <= io_f1_req_pc[19:11] ^ io_f1_req_ghist[8:0] ^ io_f1_req_ghist[17:9] ^ io_f1_req_ghist[26:18] ^ io_f1_req_ghist[35:27] ^ io_f1_req_ghist[44:36] ^ io_f1_req_ghist[53:45] ^ io_f1_req_ghist[62:54] ^ {8'h0, io_f1_req_ghist[63]};	// @[frontend.scala:163:35, tage.scala:53:11, :55:25, :62:{30,50}, :95:29]
    io_f3_resp_0_valid_REG <= _table_R0_data[12] & _table_R0_data[11:3] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    ...
    io_f3_resp_1_valid_REG <= _table_R0_data[25] & _table_R0_data[24:16] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_1_bits_u_REG <= {_hi_us_R0_data[1], _lo_us_R0_data[1]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_1_bits_ctr_REG <= _table_R0_data[15:13];	// @[tage.scala:91:27, :97:87, :106:38]
    io_f3_resp_2_valid_REG <= _table_R0_data[38] & _table_R0_data[37:29] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_2_bits_u_REG <= {_hi_us_R0_data[2], _lo_us_R0_data[2]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_2_bits_ctr_REG <= _table_R0_data[28:26];	// @[tage.scala:91:27, :97:87, :106:38]
    io_f3_resp_3_valid_REG <= _table_R0_data[51] & _table_R0_data[50:42] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_3_bits_u_REG <= {_hi_us_R0_data[3], _lo_us_R0_data[3]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_3_bits_ctr_REG <= _table_R0_data[41:39];	// @[tage.scala:91:27, :97:87, :106:38]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_tag = _RANDOM_0[16:8];	// @[tage.scala:72:28, :95:29]
        ...
        clear_u_ctr = _RANDOM_1[27:9];	// @[tage.scala:106:38, :109:28]
        wrbypass_tags_0 = {_RANDOM_1[31:28], _RANDOM_2[4:0]};	// @[tage.scala:106:38, :141:29]
        wrbypass_tags_1 = _RANDOM_2[13:5];	// @[tage.scala:141:29]
        wrbypass_idxs_0 = _RANDOM_2[20:14];	// @[tage.scala:141:29, :142:29]
        wrbypass_idxs_1 = _RANDOM_2[27:21];	// @[tage.scala:141:29, :142:29]
        wrbypass_0_0 = _RANDOM_2[30:28];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_1 = {_RANDOM_2[31], _RANDOM_3[1:0]};	// @[tage.scala:141:29, :143:29]
        wrbypass_0_2 = _RANDOM_3[4:2];	// @[tage.scala:143:29]
        wrbypass_0_3 = _RANDOM_3[7:5];	// @[tage.scala:143:29]
        wrbypass_1_0 = _RANDOM_3[10:8];	// @[tage.scala:143:29]
        wrbypass_1_1 = _RANDOM_3[13:11];	// @[tage.scala:143:29]
        wrbypass_1_2 = _RANDOM_3[16:14];	// @[tage.scala:143:29]
        wrbypass_1_3 = _RANDOM_3[19:17];	// @[tage.scala:143:29]
        wrbypass_enq_idx = _RANDOM_3[20];	// @[tage.scala:143:29, :144:33]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  hi_us_4 hi_us (	// @[tage.scala:89:27]
  ...
  lo_us_4 lo_us (	// @[tage.scala:90:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_4 table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
