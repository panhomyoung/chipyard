...
module PTW(
  ...
  wire            _GEN_19 = _T_140 | _GEN_16;	// @[PTW.scala:240:30, :242:27, :260:24, :585:18]
  wire            _GEN_20 = _T_150 | _T_151 | ~((&state) & ~homogeneous);	// @[PTW.scala:233:22, :259:18, :551:36, :585:18, :650:{13,27}, :651:15]
  always @(posedge clock) begin
    ...
    resp_valid_0 <= mem_resp_valid & ~_GEN_11 & _GEN_17 | ~_GEN_19 & (_T_151 ? io_mem_s2_xcpt_ae_ld & _GEN_17 : (&state) & _GEN_17);	// @[PTW.scala:233:22, :242:27, :293:31, :410:26, :585:18, :641:35, :644:32, :649:30, :683:30, :689:25, :692:21, :701:57, :711:19]
    resp_valid_1 <= mem_resp_valid & ~_GEN_11 & _GEN_18 | ~_GEN_19 & (_T_151 ? io_mem_s2_xcpt_ae_ld & _GEN_18 : (&state) & _GEN_18);	// @[PTW.scala:233:22, :242:27, :293:31, :410:26, :585:18, :641:35, :644:32, :649:30, :683:30, :689:25, :692:21, :701:57, :711:19]
    ...
    if (do_switch) begin	// @[PTW.scala:583:30, :689:25, :692:21]
      ...
      if (mem_resp_valid) begin	// @[PTW.scala:293:31]
        if (traverse)	// @[PTW.scala:316:48]
          ...
          else if (_GEN_20) begin	// @[PTW.scala:259:18, :585:18]
          end
  ...
  Arbiter_20 arb (	// @[PTW.scala:236:19]
