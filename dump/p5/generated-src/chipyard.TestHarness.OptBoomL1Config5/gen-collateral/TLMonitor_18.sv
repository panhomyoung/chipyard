...
module TLMonitor_18(
  ...
  wire [526:0] _d_sizes_clr_T_5 = 527'hFF << {518'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [515:0] _a_sizes_set_T_1 = {511'h0, _T_1101 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {507'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_341 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_341 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_341 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             _GEN_19 = io_in_d_bits_size < 4'h3;	// @[Misc.scala:205:21, Monitor.scala:312:27]
    ...
    wire  [263:0]    _GEN_26 = {255'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_341) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_341) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[5:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :706:27, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:{31,45,65}, :671:42, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        source = _RANDOM_0[24:19];	// @[Edges.scala:228:27, Monitor.scala:387:22]
        address = {_RANDOM_0[31:25], _RANDOM_1[23:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        d_first_counter = {_RANDOM_1[31:24], _RANDOM_2[0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        opcode_1 = _RANDOM_2[3:1];	// @[Edges.scala:228:27, Monitor.scala:535:22]
        param_1 = _RANDOM_2[5:4];	// @[Edges.scala:228:27, Monitor.scala:536:22]
        size_1 = _RANDOM_2[9:6];	// @[Edges.scala:228:27, Monitor.scala:537:22]
        source_1 = _RANDOM_2[15:10];	// @[Edges.scala:228:27, Monitor.scala:538:22]
        sink = _RANDOM_2[16];	// @[Edges.scala:228:27, Monitor.scala:539:22]
        denied = _RANDOM_2[17];	// @[Edges.scala:228:27, Monitor.scala:540:22]
        inflight = {_RANDOM_2[31:18], _RANDOM_3[18:0]};	// @[Edges.scala:228:27, Monitor.scala:611:27]
        inflight_opcodes = {_RANDOM_3[31:19], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[22:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_7[31:23], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[30:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = {_RANDOM_15[31], _RANDOM_16[7:0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_16[16:8];	// @[Edges.scala:228:27]
        watchdog = {_RANDOM_16[31:17], _RANDOM_17[16:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_31[15:7];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
