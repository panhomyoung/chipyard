...
module GenericSerializer(
  ...
  reg  [1:0]   sendCount;	// @[Counter.scala:61:40]
  ...
  always @(posedge clock) begin
    if (_T_2)	// @[Decoupled.scala:51:35]
      data <= {32'h0, data[122:32]};	// @[Serdes.scala:173:17, :187:37]
    ...
    if (reset) begin
      ...
      sendCount <= 2'h0;	// @[Counter.scala:61:40]
    end
    else begin
      sending <= ~(_T_2 & (&sendCount)) & (_T_1 | sending);	// @[Counter.scala:61:40, :73:24, :117:24, :118:{16,23}, Decoupled.scala:51:35, Serdes.scala:175:24, :182:21, :184:13, :189:{19,29}]
      if (_T_2)	// @[Decoupled.scala:51:35]
        sendCount <= sendCount + 2'h1;	// @[Counter.scala:61:40, :77:24]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_2 = `RANDOM;
        _RANDOM_3 = `RANDOM;
        data = {_RANDOM_0, _RANDOM_1, _RANDOM_2, _RANDOM_3[26:0]};	// @[Serdes.scala:173:17]
        sending = _RANDOM_3[27];	// @[Serdes.scala:173:17, :175:24]
        sendCount = _RANDOM_3[29:28];	// @[Counter.scala:61:40, Serdes.scala:173:17]
      `endif // RANDOMIZE_REG_INIT
    end // initial
