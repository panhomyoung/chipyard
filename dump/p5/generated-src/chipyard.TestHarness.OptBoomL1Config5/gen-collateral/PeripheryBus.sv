...
module PeripheryBus(
  ...
  wire        _coupler_to_slave_named_bootaddressreg_auto_buffer_in_a_ready;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_size;	// @[LazyModule.scala:489:27]
  wire [6:0]  _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source;	// @[LazyModule.scala:489:27]
  wire [63:0] _coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_data;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_opcode;	// @[LazyModule.scala:489:27]
  wire [2:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_param;	// @[LazyModule.scala:489:27]
  wire [1:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_size;	// @[LazyModule.scala:489:27]
  wire [10:0] _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source;	// @[LazyModule.scala:489:27]
  wire [14:0] _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_address;	// @[LazyModule.scala:489:27]
  wire [7:0]  _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask;	// @[LazyModule.scala:489:27]
  wire [63:0] _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_corrupt;	// @[LazyModule.scala:489:27]
  wire        _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready;	// @[LazyModule.scala:489:27]
  ...
  wire        out_front_bits_read = _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_opcode == 3'h4;	// @[LazyModule.scala:489:27, RegisterRouter.scala:71:36]
  wire        _out_out_bits_data_T_1 = _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_address[11:3] == 9'h0;	// @[Edges.scala:191:34, LazyModule.scala:489:27, RegisterRouter.scala:72:19, :82:24]
  wire        valids_0 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[0];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_1 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[1];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_2 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[2];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_3 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[3];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_4 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[4];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_5 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[5];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_6 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[6];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  wire        valids_7 = out_woready_7 & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask[7];	// @[Bitwise.scala:28:17, LazyModule.scala:489:27, RegisterRouter.scala:82:24]
  assign out_woready_7 = _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid & _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready & ~out_front_bits_read & _out_out_bits_data_T_1;	// @[LazyModule.scala:489:27, RegisterRouter.scala:71:36, :82:24]
  wire [2:0]  bundleIn_0_1_d_bits_opcode = {2'h0, out_front_bits_read};	// @[PeripheryBus.scala:50:30, RegisterRouter.scala:71:36, :97:19]
  always @(posedge _fixedClockNode_auto_out_0_clock) begin	// @[ClockGroup.scala:110:107]
    ...
    else if (valids_0 | valids_1 | valids_2 | valids_3 | valids_4 | valids_5 | valids_6 | valids_7)	// @[RegField.scala:154:27, RegisterRouter.scala:82:24]
      bootAddrReg <= {valids_7 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[63:56] : bootAddrReg[63:56], valids_6 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[55:48] : bootAddrReg[55:48], valids_5 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[47:40] : bootAddrReg[47:40], valids_4 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[39:32] : bootAddrReg[39:32], valids_3 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[31:24] : bootAddrReg[31:24], valids_2 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[23:16] : bootAddrReg[23:16], valids_1 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[15:8] : bootAddrReg[15:8], valids_0 ? _coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_data[7:0] : bootAddrReg[7:0]};	// @[BootAddrReg.scala:34:32, LazyModule.scala:489:27, RegField.scala:151:57, :152:31, :154:52, :158:{20,33}, RegisterRouter.scala:82:24]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        bootAddrReg = {_RANDOM_0, _RANDOM_1};	// @[BootAddrReg.scala:34:32]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLXbar_2 out_xbar (	// @[PeripheryBus.scala:50:30]
    ...
    .auto_out_0_a_ready        (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_a_ready),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_valid        (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_valid),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_opcode  (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_opcode),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_size    (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_size),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_source  (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_source),	// @[LazyModule.scala:489:27]
    .auto_out_0_d_bits_data    (_coupler_to_slave_named_bootaddressreg_auto_buffer_in_d_bits_data),	// @[LazyModule.scala:489:27]
  ...
  TLInterconnectCoupler_4 coupler_to_slave_named_bootaddressreg (	// @[LazyModule.scala:489:27]
    .clock                              (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                              (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    ...
    .auto_fragmenter_out_a_ready        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready),	// @[LazyModule.scala:489:27]
    .auto_fragmenter_out_d_valid        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid),	// @[LazyModule.scala:489:27]
    .auto_fragmenter_out_d_bits_opcode  (bundleIn_0_1_d_bits_opcode),	// @[RegisterRouter.scala:97:19]
    .auto_fragmenter_out_d_bits_size    (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .auto_fragmenter_out_d_bits_source  (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source),	// @[LazyModule.scala:489:27]
    .auto_fragmenter_out_d_bits_data    (_out_out_bits_data_T_1 ? bootAddrReg : 64'h0),	// @[BootAddrReg.scala:34:32, Bundles.scala:259:74, RegisterRouter.scala:82:24]
  ...
  TLMonitor_14 monitor (	// @[Nodes.scala:24:25]
    .clock                (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
    .io_in_a_ready        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready),	// @[LazyModule.scala:489:27]
    .io_in_a_valid        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_opcode  (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_opcode),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_param   (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_param),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_size    (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_source  (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_address (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_address),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_mask    (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_mask),	// @[LazyModule.scala:489:27]
    .io_in_a_bits_corrupt (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_corrupt),	// @[LazyModule.scala:489:27]
    .io_in_d_ready        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_d_ready),	// @[LazyModule.scala:489:27]
    .io_in_d_valid        (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_valid),	// @[LazyModule.scala:489:27]
    .io_in_d_bits_opcode  (bundleIn_0_1_d_bits_opcode),	// @[RegisterRouter.scala:97:19]
    .io_in_d_bits_size    (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_size),	// @[LazyModule.scala:489:27]
    .io_in_d_bits_source  (_coupler_to_slave_named_bootaddressreg_auto_fragmenter_out_a_bits_source)	// @[LazyModule.scala:489:27]
  );
