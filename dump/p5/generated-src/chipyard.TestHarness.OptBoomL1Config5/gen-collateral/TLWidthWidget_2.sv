...
module TLWidthWidget_2(
  ...
  wire         _repeated_repeater_1_io_enq_ready;	// @[Repeater.scala:35:26]
  wire         _repeated_repeater_1_io_deq_valid;	// @[Repeater.scala:35:26]
  wire [2:0]   _repeated_repeater_1_io_deq_bits_opcode;	// @[Repeater.scala:35:26]
  wire [2:0]   _repeated_repeater_1_io_deq_bits_size;	// @[Repeater.scala:35:26]
  wire [31:0]  _repeated_repeater_1_io_deq_bits_address;	// @[Repeater.scala:35:26]
  wire [127:0] _repeated_repeater_1_io_deq_bits_data;	// @[Repeater.scala:35:26]
  ...
  wire         repeat_last = repeat_count == ~(_repeat_limit_T_1[3]) | _repeated_repeater_io_deq_bits_opcode[2];	// @[Edges.scala:91:37, Repeater.scala:35:26, WidthWidget.scala:100:26, :102:{25,35}, package.scala:235:{46,71,76}]
  ...
  wire [10:0]  _limit_T_1 = 11'hF << auto_out_d_bits_size;	// @[package.scala:235:71]
  reg          count;	// @[WidthWidget.scala:35:27]
  wire         last = count == ~(_limit_T_1[3]) | ~(auto_out_d_bits_opcode[0]);	// @[Edges.scala:105:36, WidthWidget.scala:35:27, :37:{26,36,39}, package.scala:235:{46,71,76}]
  ...
  wire [10:0]  _repeat_limit_T_5 = 11'hF << _repeated_repeater_1_io_deq_bits_size;	// @[Repeater.scala:35:26, package.scala:235:71]
  reg          repeat_count_1;	// @[WidthWidget.scala:100:26]
  wire         repeat_last_1 = repeat_count_1 == ~(_repeat_limit_T_5[3]) | ~(_repeated_repeater_1_io_deq_bits_opcode[0]);	// @[Edges.scala:101:36, Repeater.scala:35:26, WidthWidget.scala:100:26, :102:{25,35,38}, package.scala:235:{46,71,76}]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      repeat_count_1 <= 1'h0;	// @[WidthWidget.scala:100:26]
    end
    else begin
      ...
      if (auto_out_c_ready & _repeated_repeater_1_io_deq_valid)	// @[Decoupled.scala:51:35, Repeater.scala:35:26]
        repeat_count_1 <= ~repeat_last_1 & repeat_count_1 - 1'h1;	// @[WidthWidget.scala:100:26, :102:35, :105:{15,24}, :106:{21,29}]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        repeat_count_1 = _RANDOM_2[15];	// @[WidthWidget.scala:61:24, :100:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  TLMonitor_6 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_mask    (16'hFFFF),	// @[Cat.scala:33:92]
    .io_in_c_ready        (_repeated_repeater_1_io_enq_ready),	// @[Repeater.scala:35:26]
  ...
  Repeater_3 repeated_repeater_1 (	// @[Repeater.scala:35:26]
    .clock               (clock),
    .reset               (reset),
    .io_repeat           (~repeat_last_1),	// @[WidthWidget.scala:102:35, :143:7]
  ...
  assign auto_in_c_ready = _repeated_repeater_1_io_enq_ready;	// @[Repeater.scala:35:26]
  ...
  assign auto_out_c_valid = _repeated_repeater_1_io_deq_valid;	// @[Repeater.scala:35:26]
  assign auto_out_c_bits_opcode = _repeated_repeater_1_io_deq_bits_opcode;	// @[Repeater.scala:35:26]
  assign auto_out_c_bits_size = _repeated_repeater_1_io_deq_bits_size;	// @[Repeater.scala:35:26]
  assign auto_out_c_bits_address = _repeated_repeater_1_io_deq_bits_address;	// @[Repeater.scala:35:26]
  assign auto_out_c_bits_data = _repeated_repeater_1_io_deq_bits_address[3] | repeat_count_1 ? _repeated_repeater_1_io_deq_bits_data[127:64] : auto_in_c_bits_data[63:0];	// @[Repeater.scala:35:26, WidthWidget.scala:100:26, :113:39, :121:24, :132:30, :159:37, :160:31]
