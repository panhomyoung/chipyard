...
module ALUExeUnit_1(
  ...
  output [7:0]  io_iresp_bits_uop_rob_idx,
  ...
  output [7:0]  io_ll_fresp_bits_uop_rob_idx,
  ...
  output [7:0]  io_ll_fresp_bits_fflags_bits_uop_rob_idx,
  ...
  wire [7:0]  _ifpu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [5:0]  _ifpu_io_resp_bits_uop_pdst;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_uop_prs1;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_uop_prs2;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_uop_prs3;	// @[execution-unit.scala:330:18]
  ...
  wire [5:0]  _ifpu_io_resp_bits_uop_stale_pdst;	// @[execution-unit.scala:330:18]
  ...
  wire [7:0]  _ifpu_io_resp_bits_fflags_bits_uop_rob_idx;	// @[execution-unit.scala:330:18]
  ...
  wire [5:0]  _ifpu_io_resp_bits_fflags_bits_uop_pdst;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_fflags_bits_uop_prs1;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_fflags_bits_uop_prs2;	// @[execution-unit.scala:330:18]
  wire [5:0]  _ifpu_io_resp_bits_fflags_bits_uop_prs3;	// @[execution-unit.scala:330:18]
  ...
  wire [5:0]  _ifpu_io_resp_bits_fflags_bits_uop_stale_pdst;	// @[execution-unit.scala:330:18]
  ...
  wire [7:0]  _imul_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:317:18]
  wire [5:0]  _imul_io_resp_bits_uop_pdst;	// @[execution-unit.scala:317:18]
  ...
  wire [7:0]  _alu_io_resp_bits_uop_rob_idx;	// @[execution-unit.scala:262:17]
  wire [5:0]  _alu_io_resp_bits_uop_pdst;	// @[execution-unit.scala:262:17]
