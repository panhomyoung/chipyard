...
module TLXbar_8(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source == 5'h10;	// @[Parameters.scala:46:9, Xbar.scala:239:55]
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  ...
  TLMonitor_41 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_source  (auto_out_b_bits_source[3:0]),	// @[Xbar.scala:230:69]
  ...
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[3:0];	// @[Xbar.scala:230:69]
  ...
  assign auto_out_a_bits_opcode = (muxStateEarly_0 ? auto_in_0_a_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:25:66, :117:30, Mux.scala:27:73]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 5'h0) | {muxStateEarly_1, 4'h0};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73, Xbar.scala:239:29, :264:23]
  ...
  assign auto_out_b_ready = ~(auto_out_b_bits_source[4]) & auto_in_0_b_ready;	// @[Mux.scala:27:73, Parameters.scala:54:{10,32}]
  ...
  assign auto_out_d_ready = ~(auto_out_d_bits_source[4]) & auto_in_0_d_ready | requestDOI_0_1;	// @[Mux.scala:27:73, Parameters.scala:46:9, :54:{10,32}]
