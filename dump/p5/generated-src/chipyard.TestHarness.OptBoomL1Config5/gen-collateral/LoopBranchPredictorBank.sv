  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s2_idx = {_RANDOM_1[31:4], _RANDOM_2[7:0]};	// @[predictor.scala:163:29, :164:29]
        s1_valid = _RANDOM_3[12];	// @[predictor.scala:168:25]
        s2_valid = _RANDOM_3[13];	// @[predictor.scala:168:25, :169:25]
        s3_valid = _RANDOM_3[14];	// @[predictor.scala:168:25, :170:25]
        s1_mask = _RANDOM_3[18:15];	// @[predictor.scala:168:25, :173:24]
        s2_mask = _RANDOM_3[22:19];	// @[predictor.scala:168:25, :174:24]
        s3_mask = _RANDOM_3[26:23];	// @[predictor.scala:168:25, :175:24]
        ...
        columns_0_io_f3_req_fire_REG = _RANDOM_15[4];	// @[loop.scala:193:14, predictor.scala:185:30]
        columns_1_io_f3_req_fire_REG = _RANDOM_15[5];	// @[loop.scala:193:14, predictor.scala:185:30]
        columns_2_io_f3_req_fire_REG = _RANDOM_15[6];	// @[loop.scala:193:14, predictor.scala:185:30]
        columns_3_io_f3_req_fire_REG = _RANDOM_15[7];	// @[loop.scala:193:14, predictor.scala:185:30]
      `endif // RANDOMIZE_REG_INIT
    end // initial
