...
module IssueSlot_32(
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[issue-slot.scala:156:12]
      ...
      if (_T_22 & ~reset & next_uop_prs1 == 6'h0) begin	// @[consts.scala:270:20, issue-slot.scala:103:21, :175:24, :176:{11,26}]
      ...
      if (_T_27 & ~reset & next_uop_prs2 == 6'h0) begin	// @[consts.scala:270:20, issue-slot.scala:103:21, :179:24, :180:{11,26}]
      ...
      if (~reset & io_spec_ld_wakeup_0_valid & io_spec_ld_wakeup_0_bits == 6'h0) begin	// @[consts.scala:270:20, issue-slot.scala:203:{12,71}]
