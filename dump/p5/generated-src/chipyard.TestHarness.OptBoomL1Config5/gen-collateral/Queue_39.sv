...
module Queue_39(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (do_enq)	// @[Decoupled.scala:51:35]
        enq_ptr_value <= enq_ptr_value + 7'h1;	// @[Counter.scala:61:40, :77:24]
      if (do_deq)	// @[Decoupled.scala:51:35]
        deq_ptr_value <= deq_ptr_value + 7'h1;	// @[Counter.scala:61:40, :77:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        enq_ptr_value = _RANDOM_0[6:0];	// @[Counter.scala:61:40]
        deq_ptr_value = _RANDOM_0[13:7];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_0[14];	// @[Counter.scala:61:40, Decoupled.scala:276:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
