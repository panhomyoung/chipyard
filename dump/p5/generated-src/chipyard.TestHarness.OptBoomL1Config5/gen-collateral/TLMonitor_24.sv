...
module TLMonitor_24(
  ...
  wire          _T_747 = _T_823 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_747 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:46:9, :52:29]
  wire [1038:0] _d_sizes_clr_T_5 = 1039'hFF << {1029'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [1027:0] _a_sizes_set_T_1 = {1023'h0, _T_747 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {1018'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire          _T_896 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire          _T_762 = _T_896 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | (_T_747 ? _a_set_T[64:0] : 65'h0)) & ~(_T_762 ? _d_clr_T[64:0] : 65'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_747 ? _a_opcodes_set_T_1[259:0] : 260'h0)) & ~(_T_762 ? _d_opcodes_clr_T_5[259:0] : 260'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_747 ? _a_sizes_set_T_1[519:0] : 520'h0)) & ~(_T_762 ? _d_sizes_clr_T_5[519:0] : 520'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_823 | _T_896)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_823 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_896 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_216 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    ...
    wire             _T_692 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_716 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    ...
    wire             _T_795 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    ...
    wire             _T_852 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [64:0]     _T_748 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [64:0]     _T_767 = inflight >> _GEN_25;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [64:0]     _T_853 = 65'h0 >> _GEN_25;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~(~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_266 & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_9 & ~reset & ~(_T_266 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:92:42, :137:65, :670:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_12 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size < 4'h4 & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & (&(io_in_a_bits_address[13:12])))) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_795 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_795 & ~d_release_ack ? _d_clr_wo_ready_T[64:0] : 65'h0) | a_set_wo_ready == 65'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:26], _RANDOM_1[7:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        d_first_counter = _RANDOM_1[16:8];	// @[Edges.scala:228:27, Monitor.scala:388:22]
        opcode_1 = _RANDOM_1[19:17];	// @[Monitor.scala:388:22, :535:22]
        param_1 = _RANDOM_1[21:20];	// @[Monitor.scala:388:22, :536:22]
        size_1 = _RANDOM_1[25:22];	// @[Monitor.scala:388:22, :537:22]
        source_1 = {_RANDOM_1[31:26], _RANDOM_2[0]};	// @[Monitor.scala:388:22, :538:22]
        sink = _RANDOM_2[1];	// @[Monitor.scala:538:22, :539:22]
        denied = _RANDOM_2[2];	// @[Monitor.scala:538:22, :540:22]
        inflight = {_RANDOM_2[31:3], _RANDOM_3, _RANDOM_4[3:0]};	// @[Monitor.scala:538:22, :611:27]
        inflight_opcodes = {_RANDOM_4[31:4], _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12[7:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_12[31:8], _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20, _RANDOM_21, _RANDOM_22, _RANDOM_23, _RANDOM_24, _RANDOM_25, _RANDOM_26, _RANDOM_27, _RANDOM_28[15:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_28[24:16];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_28[31:25], _RANDOM_29[1:0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_29[31:2], _RANDOM_30[1:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_56[31:24], _RANDOM_57[0]};	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
