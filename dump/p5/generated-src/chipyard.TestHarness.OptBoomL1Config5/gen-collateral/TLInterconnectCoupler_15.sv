...
module TLInterconnectCoupler_15(
  ...
  wire [10:0] _fragmenter_auto_out_a_bits_source;	// @[Fragmenter.scala:334:34]
  wire [20:0] _fragmenter_auto_out_a_bits_address;	// @[Fragmenter.scala:334:34]
  ...
  TLBuffer_10 buffer (	// @[Buffer.scala:69:28]
    .clock                   (clock),
    .reset                   (reset),
  ...
  TLFragmenter_7 fragmenter (	// @[Fragmenter.scala:334:34]
    .clock                   (clock),
    .reset                   (reset),
