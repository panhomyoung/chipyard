...
module TLWidthWidget(
  ...
  always @(posedge clock) begin
    if (reset) begin
      repeat_count <= 1'h0;	// @[Edges.scala:91:28, WidthWidget.scala:100:26]
      count <= 1'h0;	// @[Edges.scala:91:28, WidthWidget.scala:35:27]
      corrupt_reg <= 1'h0;	// @[Edges.scala:91:28, WidthWidget.scala:40:32]
      bundleIn_0_d_bits_data_rdata_written_once <= 1'h0;	// @[Edges.scala:91:28, WidthWidget.scala:57:41]
    end
    else begin
