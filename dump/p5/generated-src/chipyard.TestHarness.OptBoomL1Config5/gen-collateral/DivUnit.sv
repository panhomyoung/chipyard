...
module DivUnit(
  ...
  reg  [15:0] r_uop_br_mask;	// @[functional-unit.scala:642:18]
  reg  [7:0]  r_uop_rob_idx;	// @[functional-unit.scala:642:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_11 = `RANDOM;
        _RANDOM_12 = `RANDOM;
        r_uop_br_mask = {_RANDOM_4[31:28], _RANDOM_5[11:0]};	// @[functional-unit.scala:642:18]
        r_uop_rob_idx = {_RANDOM_6[31:30], _RANDOM_7[5:0]};	// @[functional-unit.scala:642:18]
        r_uop_pdst = _RANDOM_7[23:18];	// @[functional-unit.scala:642:18]
        r_uop_bypassable = _RANDOM_10[27];	// @[functional-unit.scala:642:18]
        r_uop_is_amo = _RANDOM_11[6];	// @[functional-unit.scala:642:18]
        r_uop_uses_stq = _RANDOM_11[8];	// @[functional-unit.scala:642:18]
        r_uop_dst_rtype = _RANDOM_12[7:6];	// @[functional-unit.scala:642:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  MulDiv div (	// @[functional-unit.scala:672:19]
    .clock             (clock),
    .reset             (reset),
