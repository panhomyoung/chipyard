...
module TageTable_3(
  ...
  wire [7:0]  _s2_req_rlous_T_1 = io_f1_req_pc[11:4] ^ io_f1_req_ghist[7:0] ^ io_f1_req_ghist[15:8];	// @[frontend.scala:163:35, tage.scala:53:11, :60:29]
  ...
  wire [7:0]  update_idx = io_update_pc[11:4] ^ io_update_hist[7:0] ^ io_update_hist[15:8];	// @[frontend.scala:163:35, tage.scala:53:11, :60:29]
  wire [7:0]  update_wdata_3_tag = io_update_pc[19:12] ^ io_update_hist[7:0] ^ io_update_hist[15:8];	// @[frontend.scala:163:35, tage.scala:53:11, :62:{30,50}]
  ...
  hi_us_2 hi_us (	// @[tage.scala:89:27]
  ...
  lo_us_2 lo_us (	// @[tage.scala:90:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
  ...
  table_2 table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
