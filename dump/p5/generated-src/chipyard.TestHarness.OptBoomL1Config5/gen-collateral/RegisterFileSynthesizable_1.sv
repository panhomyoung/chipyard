...
module RegisterFileSynthesizable_1(
  ...
  `ifndef SYNTHESIS
    wire         _T_15 = io_write_ports_0_bits_addr == 6'h0;	// @[regfile.scala:174:45]
    always @(posedge clock) begin	// @[regfile.scala:171:15]
      ...
      if (~reset & ~(~io_write_ports_1_valid | ~io_write_ports_2_valid | io_write_ports_1_bits_addr != io_write_ports_2_bits_addr | io_write_ports_1_bits_addr == 6'h0)) begin	// @[regfile.scala:171:15, :172:16, :173:{45,78}, :174:45]
        if (`ASSERT_VERBOSE_COND_)	// @[regfile.scala:171:15]
          $error("Assertion failed: [regfile] too many writers a register\n    at regfile.scala:171 assert(!io.write_ports(i).valid ||\n");	// @[regfile.scala:171:15]
        if (`STOP_COND_)	// @[regfile.scala:171:15]
          $fatal;	// @[regfile.scala:171:15]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        read_addrs_0 = _RANDOM_0[5:0];	// @[regfile.scala:125:50]
        read_addrs_1 = _RANDOM_0[11:6];	// @[regfile.scala:125:50]
        read_addrs_2 = _RANDOM_0[17:12];	// @[regfile.scala:125:50]
        read_addrs_3 = _RANDOM_0[23:18];	// @[regfile.scala:125:50]
        read_addrs_4 = _RANDOM_0[29:24];	// @[regfile.scala:125:50]
        read_addrs_5 = {_RANDOM_0[31:30], _RANDOM_1[3:0]};	// @[regfile.scala:125:50]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  regfile_combMem_0 regfile_ext (	// @[regfile.scala:117:20]
