...
module IntToFPUnit(
  ...
  wire [15:0] _io_resp_bits_uop_br_mask_output = r_uops_1_br_mask & ~io_brupdate_b1_resolve_mask;	// @[functional-unit.scala:227:23, util.scala:85:{25,27}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        r_uops_0_br_mask = {_RANDOM_4[31:30], _RANDOM_5[13:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_br_tag = _RANDOM_5[17:14];	// @[functional-unit.scala:227:23]
        r_uops_0_ftq_idx = _RANDOM_5[23:18];	// @[functional-unit.scala:227:23]
        r_uops_0_edge_inst = _RANDOM_5[24];	// @[functional-unit.scala:227:23]
        r_uops_0_pc_lob = _RANDOM_5[30:25];	// @[functional-unit.scala:227:23]
        r_uops_0_taken = _RANDOM_5[31];	// @[functional-unit.scala:227:23]
        r_uops_0_imm_packed = _RANDOM_6[19:0];	// @[functional-unit.scala:227:23]
        r_uops_0_csr_addr = _RANDOM_6[31:20];	// @[functional-unit.scala:227:23]
        r_uops_0_rob_idx = _RANDOM_7[7:0];	// @[functional-unit.scala:227:23]
        r_uops_0_ldq_idx = _RANDOM_7[12:8];	// @[functional-unit.scala:227:23]
        r_uops_0_stq_idx = _RANDOM_7[17:13];	// @[functional-unit.scala:227:23]
        r_uops_0_rxq_idx = _RANDOM_7[19:18];	// @[functional-unit.scala:227:23]
        r_uops_0_pdst = _RANDOM_7[25:20];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1 = _RANDOM_7[31:26];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2 = _RANDOM_8[5:0];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3 = _RANDOM_8[11:6];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred = _RANDOM_8[17:12];	// @[functional-unit.scala:227:23]
        r_uops_0_prs1_busy = _RANDOM_8[18];	// @[functional-unit.scala:227:23]
        r_uops_0_prs2_busy = _RANDOM_8[19];	// @[functional-unit.scala:227:23]
        r_uops_0_prs3_busy = _RANDOM_8[20];	// @[functional-unit.scala:227:23]
        r_uops_0_ppred_busy = _RANDOM_8[21];	// @[functional-unit.scala:227:23]
        r_uops_0_stale_pdst = _RANDOM_8[27:22];	// @[functional-unit.scala:227:23]
        r_uops_0_exception = _RANDOM_8[28];	// @[functional-unit.scala:227:23]
        r_uops_0_exc_cause = {_RANDOM_8[31:29], _RANDOM_9, _RANDOM_10[28:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_bypassable = _RANDOM_10[29];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_cmd = {_RANDOM_10[31:30], _RANDOM_11[2:0]};	// @[functional-unit.scala:227:23]
        r_uops_0_mem_size = _RANDOM_11[4:3];	// @[functional-unit.scala:227:23]
        r_uops_0_mem_signed = _RANDOM_11[5];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fence = _RANDOM_11[6];	// @[functional-unit.scala:227:23]
        r_uops_0_is_fencei = _RANDOM_11[7];	// @[functional-unit.scala:227:23]
        r_uops_0_is_amo = _RANDOM_11[8];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_ldq = _RANDOM_11[9];	// @[functional-unit.scala:227:23]
        r_uops_0_uses_stq = _RANDOM_11[10];	// @[functional-unit.scala:227:23]
        r_uops_0_is_sys_pc2epc = _RANDOM_11[11];	// @[functional-unit.scala:227:23]
        r_uops_0_is_unique = _RANDOM_11[12];	// @[functional-unit.scala:227:23]
        r_uops_0_flush_on_commit = _RANDOM_11[13];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_is_rs1 = _RANDOM_11[14];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst = _RANDOM_11[20:15];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1 = _RANDOM_11[26:21];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2 = {_RANDOM_11[31:27], _RANDOM_12[0]};	// @[functional-unit.scala:227:23]
        r_uops_0_lrs3 = _RANDOM_12[6:1];	// @[functional-unit.scala:227:23]
        r_uops_0_ldst_val = _RANDOM_12[7];	// @[functional-unit.scala:227:23]
        r_uops_0_dst_rtype = _RANDOM_12[9:8];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs1_rtype = _RANDOM_12[11:10];	// @[functional-unit.scala:227:23]
        r_uops_0_lrs2_rtype = _RANDOM_12[13:12];	// @[functional-unit.scala:227:23]
        r_uops_0_frs3_en = _RANDOM_12[14];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_val = _RANDOM_12[15];	// @[functional-unit.scala:227:23]
        r_uops_0_fp_single = _RANDOM_12[16];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_pf_if = _RANDOM_12[17];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ae_if = _RANDOM_12[18];	// @[functional-unit.scala:227:23]
        r_uops_0_xcpt_ma_if = _RANDOM_12[19];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_debug_if = _RANDOM_12[20];	// @[functional-unit.scala:227:23]
        r_uops_0_bp_xcpt_if = _RANDOM_12[21];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_fsrc = _RANDOM_12[23:22];	// @[functional-unit.scala:227:23]
        r_uops_0_debug_tsrc = _RANDOM_12[25:24];	// @[functional-unit.scala:227:23]
        r_uops_1_uopc = {_RANDOM_12[31:26], _RANDOM_13[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_inst = {_RANDOM_13[31:1], _RANDOM_14[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_debug_inst = {_RANDOM_14[31:1], _RANDOM_15[0]};	// @[functional-unit.scala:227:23]
        r_uops_1_is_rvc = _RANDOM_15[1];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_pc = {_RANDOM_15[31:2], _RANDOM_16[9:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_iq_type = _RANDOM_16[12:10];	// @[functional-unit.scala:227:23]
        r_uops_1_fu_code = _RANDOM_16[22:13];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_br_type = _RANDOM_16[26:23];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op1_sel = _RANDOM_16[28:27];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op2_sel = _RANDOM_16[31:29];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_imm_sel = _RANDOM_17[2:0];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_op_fcn = _RANDOM_17[6:3];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_fcn_dw = _RANDOM_17[7];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_csr_cmd = _RANDOM_17[10:8];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_load = _RANDOM_17[11];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_sta = _RANDOM_17[12];	// @[functional-unit.scala:227:23]
        r_uops_1_ctrl_is_std = _RANDOM_17[13];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_state = _RANDOM_17[15:14];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p1_poisoned = _RANDOM_17[16];	// @[functional-unit.scala:227:23]
        r_uops_1_iw_p2_poisoned = _RANDOM_17[17];	// @[functional-unit.scala:227:23]
        r_uops_1_is_br = _RANDOM_17[18];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jalr = _RANDOM_17[19];	// @[functional-unit.scala:227:23]
        r_uops_1_is_jal = _RANDOM_17[20];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sfb = _RANDOM_17[21];	// @[functional-unit.scala:227:23]
        r_uops_1_br_mask = {_RANDOM_17[31:22], _RANDOM_18[5:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_br_tag = _RANDOM_18[9:6];	// @[functional-unit.scala:227:23]
        r_uops_1_ftq_idx = _RANDOM_18[15:10];	// @[functional-unit.scala:227:23]
        r_uops_1_edge_inst = _RANDOM_18[16];	// @[functional-unit.scala:227:23]
        r_uops_1_pc_lob = _RANDOM_18[22:17];	// @[functional-unit.scala:227:23]
        r_uops_1_taken = _RANDOM_18[23];	// @[functional-unit.scala:227:23]
        r_uops_1_imm_packed = {_RANDOM_18[31:24], _RANDOM_19[11:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_csr_addr = _RANDOM_19[23:12];	// @[functional-unit.scala:227:23]
        r_uops_1_rob_idx = _RANDOM_19[31:24];	// @[functional-unit.scala:227:23]
        r_uops_1_ldq_idx = _RANDOM_20[4:0];	// @[functional-unit.scala:227:23]
        r_uops_1_stq_idx = _RANDOM_20[9:5];	// @[functional-unit.scala:227:23]
        r_uops_1_rxq_idx = _RANDOM_20[11:10];	// @[functional-unit.scala:227:23]
        r_uops_1_pdst = _RANDOM_20[17:12];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1 = _RANDOM_20[23:18];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2 = _RANDOM_20[29:24];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3 = {_RANDOM_20[31:30], _RANDOM_21[3:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_ppred = _RANDOM_21[9:4];	// @[functional-unit.scala:227:23]
        r_uops_1_prs1_busy = _RANDOM_21[10];	// @[functional-unit.scala:227:23]
        r_uops_1_prs2_busy = _RANDOM_21[11];	// @[functional-unit.scala:227:23]
        r_uops_1_prs3_busy = _RANDOM_21[12];	// @[functional-unit.scala:227:23]
        r_uops_1_ppred_busy = _RANDOM_21[13];	// @[functional-unit.scala:227:23]
        r_uops_1_stale_pdst = _RANDOM_21[19:14];	// @[functional-unit.scala:227:23]
        r_uops_1_exception = _RANDOM_21[20];	// @[functional-unit.scala:227:23]
        r_uops_1_exc_cause = {_RANDOM_21[31:21], _RANDOM_22, _RANDOM_23[20:0]};	// @[functional-unit.scala:227:23]
        r_uops_1_bypassable = _RANDOM_23[21];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_cmd = _RANDOM_23[26:22];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_size = _RANDOM_23[28:27];	// @[functional-unit.scala:227:23]
        r_uops_1_mem_signed = _RANDOM_23[29];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fence = _RANDOM_23[30];	// @[functional-unit.scala:227:23]
        r_uops_1_is_fencei = _RANDOM_23[31];	// @[functional-unit.scala:227:23]
        r_uops_1_is_amo = _RANDOM_24[0];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_ldq = _RANDOM_24[1];	// @[functional-unit.scala:227:23]
        r_uops_1_uses_stq = _RANDOM_24[2];	// @[functional-unit.scala:227:23]
        r_uops_1_is_sys_pc2epc = _RANDOM_24[3];	// @[functional-unit.scala:227:23]
        r_uops_1_is_unique = _RANDOM_24[4];	// @[functional-unit.scala:227:23]
        r_uops_1_flush_on_commit = _RANDOM_24[5];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_is_rs1 = _RANDOM_24[6];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst = _RANDOM_24[12:7];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1 = _RANDOM_24[18:13];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2 = _RANDOM_24[24:19];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs3 = _RANDOM_24[30:25];	// @[functional-unit.scala:227:23]
        r_uops_1_ldst_val = _RANDOM_24[31];	// @[functional-unit.scala:227:23]
        r_uops_1_dst_rtype = _RANDOM_25[1:0];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs1_rtype = _RANDOM_25[3:2];	// @[functional-unit.scala:227:23]
        r_uops_1_lrs2_rtype = _RANDOM_25[5:4];	// @[functional-unit.scala:227:23]
        r_uops_1_frs3_en = _RANDOM_25[6];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_val = _RANDOM_25[7];	// @[functional-unit.scala:227:23]
        r_uops_1_fp_single = _RANDOM_25[8];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_pf_if = _RANDOM_25[9];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ae_if = _RANDOM_25[10];	// @[functional-unit.scala:227:23]
        r_uops_1_xcpt_ma_if = _RANDOM_25[11];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_debug_if = _RANDOM_25[12];	// @[functional-unit.scala:227:23]
        r_uops_1_bp_xcpt_if = _RANDOM_25[13];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_fsrc = _RANDOM_25[15:14];	// @[functional-unit.scala:227:23]
        r_uops_1_debug_tsrc = _RANDOM_25[17:16];	// @[functional-unit.scala:227:23]
        out_double_v = _RANDOM_25[18];	// @[Valid.scala:130:22, functional-unit.scala:227:23]
        out_double_b = _RANDOM_25[19];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
        out_double_outPipe_bits = _RANDOM_25[21];	// @[Reg.scala:19:16, functional-unit.scala:227:23]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  UOPCodeFPUDecoder fp_decoder (	// @[functional-unit.scala:590:26]
  ...
  IntToFP ifpu (	// @[functional-unit.scala:614:20]
    .clock                (clock),
    .reset                (reset),
  ...
  assign io_resp_valid = r_valids_1 & (io_brupdate_b1_mispredict_mask & r_uops_1_br_mask) == 16'h0;	// @[functional-unit.scala:226:27, :227:23, :247:47, util.scala:118:{51,59}]
  ...
  assign io_resp_bits_data = out_double_outPipe_bits ? _ifpu_io_out_bits_data : {12'hFFF, _ifpu_io_out_bits_data[31], 20'hFFFFF, _ifpu_io_out_bits_data[32], _ifpu_io_out_bits_data[30:0]};	// @[Cat.scala:33:92, FPU.scala:332:42, :334:8, :336:8, :337:8, Reg.scala:19:16, functional-unit.scala:614:20, package.scala:33:76]
