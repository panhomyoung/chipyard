...
module TLWidthWidget_1(
  ...
  wire         _repeated_repeater_io_deq_bits_source;	// @[Repeater.scala:35:26]
  wire [1:0]   _repeated_repeater_io_deq_bits_sink;	// @[Repeater.scala:35:26]
  ...
  wire         last = count == ~(_limit_T_1[3]) | auto_in_a_bits_opcode[2];	// @[Edges.scala:91:37, WidthWidget.scala:35:27, :37:{26,36}, package.scala:235:{46,71,76}]
  ...
  wire         repeat_last = repeat_count == ~(_repeat_limit_T_1[3]) | ~(_repeated_repeater_io_deq_bits_opcode[0]);	// @[Edges.scala:105:36, Repeater.scala:35:26, WidthWidget.scala:100:26, :102:{25,35,38}, package.scala:235:{46,71,76}]
  ...
  always @(posedge clock) begin
    ...
    if (repeat_count) begin	// @[WidthWidget.scala:100:26]
      ...
      repeat_sel_hold_r <= repeat_sel_sel_sources_0;	// @[Reg.scala:19:16, WidthWidget.scala:181:27]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        corrupt_reg = _RANDOM_0[1];	// @[WidthWidget.scala:35:27, :40:32]
        ...
        repeat_sel_hold_r = _RANDOM_2[14];	// @[Reg.scala:19:16, WidthWidget.scala:61:24]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_bits_data = (repeat_count ? repeat_sel_hold_r : repeat_sel_sel_sources_0) & _repeat_limit_T_1[3] | repeat_count ? _repeated_repeater_io_deq_bits_data[127:64] : auto_out_d_bits_data[63:0];	// @[Reg.scala:19:16, Repeater.scala:35:26, WidthWidget.scala:100:26, :116:25, :117:16, :121:24, :132:30, :159:37, :160:31, :181:27, package.scala:235:{71,76}]
