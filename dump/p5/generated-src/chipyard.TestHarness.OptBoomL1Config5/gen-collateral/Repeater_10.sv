  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_address = {_RANDOM_0[31:17], _RANDOM_1[5:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_mask = _RANDOM_1[13:6];	// @[Repeater.scala:20:18]
        saved_corrupt = _RANDOM_3[14];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
