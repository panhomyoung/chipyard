...
module TageTable(
  ...
  wire [6:0]  _GEN = {5'h0, io_f1_req_ghist[1:0]};	// @[tage.scala:53:11, :60:29]
  ...
  wire [6:0]  _GEN_0 = {5'h0, io_update_hist[1:0]};	// @[tage.scala:53:11, :60:29]
  ...
  table_0 table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
