...
module TLMonitor_23(
  ...
  wire [1026:0] _a_opcodes_set_T_1 = {1023'h0, _T_747 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:52:29]
  ...
  wire          _T_742 = _T_896 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [519:0]    _GEN_23 = {510'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire  [64:0]     _T_767 = inflight >> _GEN_24;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [64:0]     _T_853 = 65'h0 >> _GEN_24;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_20 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :338:51, Parameters.scala:1125:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_21 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :346:55, Parameters.scala:1125:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_22 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :354:49, Parameters.scala:1125:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
