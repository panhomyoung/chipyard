...
module TLDebugModuleOuter(
  ...
  wire       DMCONTROLWrData_setresethaltreq;	// @[RegisterRouter.scala:82:24]
  wire       DMCONTROLWrData_clrresethaltreq;	// @[RegisterRouter.scala:82:24]
  ...
  wire       hrmaskNxt_0 = ~(~DMCONTROLReg_dmactive | out_woready_12 & DMCONTROLWrData_clrresethaltreq) & (out_woready_12 & DMCONTROLWrData_setresethaltreq | hrmaskReg_0);	// @[Debug.scala:374:31, :393:11, :514:28, :516:15, :518:44, :519:30, :520:{39,102}, :521:30, :522:{39,102}, :523:30, RegisterRouter.scala:82:24]
  wire       out_front_bits_read = auto_dmi_in_a_bits_opcode == 3'h4;	// @[RegisterRouter.scala:71:36]
  wire       _out_out_bits_data_WIRE_1 = {auto_dmi_in_a_bits_address[4], auto_dmi_in_a_bits_address[2]} == 2'h0;	// @[RegisterRouter.scala:82:24, :97:19]
  assign DMCONTROLWrData_clrresethaltreq = auto_dmi_in_a_bits_data[2];	// @[RegisterRouter.scala:82:24]
  assign DMCONTROLWrData_setresethaltreq = auto_dmi_in_a_bits_data[3];	// @[RegisterRouter.scala:82:24]
  assign out_woready_12 = auto_dmi_in_a_valid & auto_dmi_in_d_ready & ~out_front_bits_read & ~(auto_dmi_in_a_bits_address[3]) & _out_out_bits_data_WIRE_1;	// @[RegisterRouter.scala:71:36, :82:24]
  ...
  wire       _io_innerCtrl_valid_output = out_woready_12 | innerCtrlValidReg;	// @[Debug.scala:625:36, :636:54, RegisterRouter.scala:82:24]
  wire       _io_innerCtrl_bits_resumereq_output = out_woready_12 & auto_dmi_in_a_bits_data[30] | innerCtrlResumeReqReg;	// @[Debug.scala:626:40, :638:{54,83}, RegisterRouter.scala:82:24]
  wire       _io_innerCtrl_bits_ackhavereset_output = out_woready_12 & auto_dmi_in_a_bits_data[28] | innerCtrlAckHaveResetReg;	// @[Debug.scala:627:43, :639:{57,89}, RegisterRouter.scala:82:24]
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      DMCONTROLReg_haltreq <= DMCONTROLReg_dmactive & (out_woready_12 ? auto_dmi_in_a_bits_data[31] : DMCONTROLReg_haltreq);	// @[Debug.scala:374:31, :392:18, :393:22, :394:20, :400:{47,75}, RegisterRouter.scala:82:24]
      DMCONTROLReg_ndmreset <= DMCONTROLReg_dmactive & (out_woready_12 ? auto_dmi_in_a_bits_data[1] : DMCONTROLReg_ndmreset);	// @[Debug.scala:374:31, :392:18, :393:22, :394:20, :396:{47,75}, RegisterRouter.scala:82:24]
      if (out_woready_12)	// @[RegisterRouter.scala:82:24]
        DMCONTROLReg_dmactive <= auto_dmi_in_a_bits_data[0];	// @[Debug.scala:374:31, RegisterRouter.scala:82:24]
      hrmaskReg_0 <= hrmaskNxt_0;	// @[Debug.scala:514:28, :518:44, :519:30, :520:102, :521:30, :522:102]
      debugIntRegs_0 <= DMCONTROLReg_dmactive & (out_woready_12 ? auto_dmi_in_a_bits_data[31] : debugIntRegs_0);	// @[Debug.scala:374:31, :595:31, :597:17, :605:44, :606:32, :609:96, :610:34, RegisterRouter.scala:82:24]
  ...
  assign auto_dmi_in_d_bits_data = _out_out_bits_data_WIRE_1 ? (auto_dmi_in_a_bits_address[3] ? 32'h112380 : {DMCONTROLReg_haltreq, 29'h0, DMCONTROLReg_ndmreset, DMCONTROLReg_dmactive & io_ctrl_dmactiveAck}) : 32'h0;	// @[Cat.scala:33:92, Debug.scala:374:31, :435:47, :529:43, MuxLiteral.scala:49:{10,48}, RegisterRouter.scala:82:24]
