...
module CoherenceManagerWrapper(
  ...
  wire [7:0]  _binder_auto_in_d_bits_source;	// @[BankBinder.scala:68:28]
  ...
  wire        _broadcast_1_auto_out_a_valid;	// @[BankedL2Params.scala:81:24]
  wire [2:0]  _broadcast_1_auto_out_a_bits_opcode;	// @[BankedL2Params.scala:81:24]
  wire [2:0]  _broadcast_1_auto_out_a_bits_param;	// @[BankedL2Params.scala:81:24]
  wire [2:0]  _broadcast_1_auto_out_a_bits_size;	// @[BankedL2Params.scala:81:24]
  wire [7:0]  _broadcast_1_auto_out_a_bits_source;	// @[BankedL2Params.scala:81:24]
  wire [31:0] _broadcast_1_auto_out_a_bits_address;	// @[BankedL2Params.scala:81:24]
  wire [7:0]  _broadcast_1_auto_out_a_bits_mask;	// @[BankedL2Params.scala:81:24]
  wire [63:0] _broadcast_1_auto_out_a_bits_data;	// @[BankedL2Params.scala:81:24]
  wire        _broadcast_1_auto_out_d_ready;	// @[BankedL2Params.scala:81:24]
  ...
  BankBinder binder (	// @[BankBinder.scala:68:28]
    .clock                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_clock),
    .reset                   (auto_subsystem_l2_clock_groups_in_member_subsystem_l2_0_reset),
    .auto_in_a_valid         (_broadcast_1_auto_out_a_valid),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_opcode   (_broadcast_1_auto_out_a_bits_opcode),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_param    (_broadcast_1_auto_out_a_bits_param),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_size     (_broadcast_1_auto_out_a_bits_size),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_source   (_broadcast_1_auto_out_a_bits_source),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_address  (_broadcast_1_auto_out_a_bits_address),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_mask     (_broadcast_1_auto_out_a_bits_mask),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_data     (_broadcast_1_auto_out_a_bits_data),	// @[BankedL2Params.scala:81:24]
    .auto_in_a_bits_corrupt  (1'h0),	// @[BankedL2Params.scala:81:24]
    .auto_in_d_ready         (_broadcast_1_auto_out_d_ready),	// @[BankedL2Params.scala:81:24]
