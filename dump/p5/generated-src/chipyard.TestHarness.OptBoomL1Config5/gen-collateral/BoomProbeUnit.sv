...
module BoomProbeUnit(
  ...
  wire [3:0]       _T = {req_param, (|way_en) ? old_coh_state : 2'h0};	// @[Cat.scala:33:92, Metadata.scala:160:16, dcache.scala:167:16, :171:19, :172:28, :173:20, :175:22]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_source = _RANDOM_0[16:13];	// @[dcache.scala:165:22, :167:16]
        req_address = {_RANDOM_0[31:17], _RANDOM_1[16:0]};	// @[dcache.scala:165:22, :167:16]
        way_en = _RANDOM_6[9:2];	// @[dcache.scala:171:19]
        old_coh_state = _RANDOM_6[11:10];	// @[dcache.scala:171:19, :173:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_meta_write_bits_data_coh_state = _GEN ? 2'h2 : _T_49 ? 2'h1 : _T_45 ? 2'h0 : {1'h0, _T_41 | _T_37 | _T_33};	// @[Cat.scala:33:92, Metadata.scala:160:16, Misc.scala:37:{36,63}, :55:20, dcache.scala:167:16]
