...
module RenameFreeList(
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[rename-freelist.scala:94:10]
      ...
      if (~reset & ~(~io_debug_pipeline_empty | (|(_T_196[6:5])))) begin	// @[Bitwise.scala:51:90, rename-freelist.scala:95:{10,11,36,67}]
