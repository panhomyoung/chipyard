...
module Queue_13(
  ...
  wire [112:0] _ram_ext_R0_data;	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[39:19];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_mask = _ram_ext_R0_data[47:40];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[111:48];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[112];	// @[Decoupled.scala:273:95]
endmodule
