...
module TLMonitor_25(
  ...
  wire [1026:0] _GEN_3 = {1018'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:656:54]
  wire [1038:0] _GEN_4 = {1030'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:677:76]
  ...
  wire          _T_733 = _T_887 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire  [259:0]    _GEN_22 = {251'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:634:44]
    wire  [259:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_22;	// @[Monitor.scala:613:35, :634:44]
    ...
    wire  [64:0]     _T_758 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    wire  [259:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_22;	// @[Monitor.scala:615:33, :634:44, :638:40]
    wire  [127:0]    _d_clr_wo_ready_T = 128'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [64:0]     _T_844 = 65'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [259:0]    _c_size_lookup_T_1 = 260'h0 >> _GEN_22;	// @[Monitor.scala:634:44, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :104:45, Parameters.scala:92:42, :137:65, :670:56]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((_source_ok_WIRE_0 | ~(|(io_in_a_bits_source[6:4])) & io_in_a_bits_source[3:0] < 4'h9 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _source_ok_WIRE_4) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_21 & ~reset & ~source_ok_1) begin	// @[Monitor.scala:49:11, :328:51, Parameters.scala:1125:46]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:19], _RANDOM_1[14:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        inflight_sizes = {_RANDOM_12[31:8], _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19, _RANDOM_20[11:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_20[14:12];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_20[17:15];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_20[31:18], _RANDOM_21[17:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = {_RANDOM_39[31:30], _RANDOM_40[0]};	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
