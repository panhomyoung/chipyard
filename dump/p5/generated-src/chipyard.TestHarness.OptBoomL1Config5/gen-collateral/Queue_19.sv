...
module Queue_19(
  ...
  ram_combMem_2 ram_ext (	// @[Decoupled.scala:273:95]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_data, io_enq_bits_mask}),	// @[Decoupled.scala:273:95]
    .R0_data (_ram_ext_R0_data)
  );
  assign io_enq_ready = ~full;	// @[Decoupled.scala:279:24, :303:19]
  assign io_deq_valid = ~empty;	// @[Decoupled.scala:278:25, :302:19]
  assign io_deq_bits_mask = _ram_ext_R0_data[7:0];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data = _ram_ext_R0_data[71:8];	// @[Decoupled.scala:273:95]
endmodule
