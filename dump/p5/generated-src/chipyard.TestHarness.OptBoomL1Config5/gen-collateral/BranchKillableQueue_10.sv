...
module BranchKillableQueue_10(
  ...
  input  [7:0]  io_enq_bits_fflags_bits_uop_rob_idx,
  ...
  output [7:0]  io_deq_bits_fflags_bits_uop_rob_idx,
  output [4:0]  io_deq_bits_fflags_bits_flags,
  output        io_empty
);

  wire [887:0]     _ram_ext_R0_data;	// @[util.scala:464:20]
  ...
  wire [7:0][15:0] _GEN_2 = {{uops_0_br_mask}, {uops_6_br_mask}, {uops_5_br_mask}, {uops_4_br_mask}, {uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [15:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [7:0][7:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_6_rob_idx}, {uops_5_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][4:0]  _GEN_4 = {{uops_0_stq_idx}, {uops_6_stq_idx}, {uops_5_stq_idx}, {uops_4_stq_idx}, {uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][5:0]  _GEN_5 = {{uops_0_pdst}, {uops_6_pdst}, {uops_5_pdst}, {uops_4_pdst}, {uops_3_pdst}, {uops_2_pdst}, {uops_1_pdst}, {uops_0_pdst}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_0 <= ~(do_deq & deq_ptr_value == 3'h0) & (_GEN_11 | valids_0 & (io_brupdate_b1_mispredict_mask & uops_0_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_1 <= ~(do_deq & deq_ptr_value == 3'h1) & (_GEN_13 | valids_1 & (io_brupdate_b1_mispredict_mask & uops_1_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_2 <= ~(do_deq & deq_ptr_value == 3'h2) & (_GEN_15 | valids_2 & (io_brupdate_b1_mispredict_mask & uops_2_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_3 <= ~(do_deq & deq_ptr_value == 3'h3) & (_GEN_17 | valids_3 & (io_brupdate_b1_mispredict_mask & uops_3_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_4 <= ~(do_deq & deq_ptr_value == 3'h4) & (_GEN_19 | valids_4 & (io_brupdate_b1_mispredict_mask & uops_4_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_5 <= ~(do_deq & deq_ptr_value == 3'h5) & (_GEN_21 | valids_5 & (io_brupdate_b1_mispredict_mask & uops_5_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
      valids_6 <= ~(do_deq & deq_ptr_value == 3'h6) & (_GEN_23 | valids_6 & (io_brupdate_b1_mispredict_mask & uops_6_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[18:3];	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_7[12:5];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[22:18];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[30:25];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[13];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[15];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[14:13];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[20];	// @[util.scala:466:20]
        uops_1_uopc = {_RANDOM_12[31], _RANDOM_13[5:0]};	// @[util.scala:466:20]
        uops_1_br_mask = {_RANDOM_17[31:27], _RANDOM_18[10:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_19[31:29], _RANDOM_20[4:0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[14:10];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[22:17];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[5];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[7];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[6:5];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[12];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_25[29:23];	// @[util.scala:466:20]
        uops_2_br_mask = {_RANDOM_30[31:19], _RANDOM_31[2:0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_32[28:21];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[6:2];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[14:9];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_36[29];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_36[31];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_37[30:29];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[4];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_38[21:15];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_43[26:11];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_45[20:13];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_45[30:26];	// @[util.scala:466:20]
        uops_3_pdst = _RANDOM_46[6:1];	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_49[21];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_49[23];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_50[22:21];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_50[28];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_51[13:7];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_56[18:3];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_58[12:5];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_58[22:18];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_58[30:25];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_62[13];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_62[15];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_63[14:13];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_63[20];	// @[util.scala:466:20]
        uops_5_uopc = {_RANDOM_63[31], _RANDOM_64[5:0]};	// @[util.scala:466:20]
        uops_5_br_mask = {_RANDOM_68[31:27], _RANDOM_69[10:0]};	// @[util.scala:466:20]
        uops_5_rob_idx = {_RANDOM_70[31:29], _RANDOM_71[4:0]};	// @[util.scala:466:20]
        uops_5_stq_idx = _RANDOM_71[14:10];	// @[util.scala:466:20]
        uops_5_pdst = _RANDOM_71[22:17];	// @[util.scala:466:20]
        uops_5_is_amo = _RANDOM_75[5];	// @[util.scala:466:20]
        uops_5_uses_stq = _RANDOM_75[7];	// @[util.scala:466:20]
        uops_5_dst_rtype = _RANDOM_76[6:5];	// @[util.scala:466:20]
        uops_5_fp_val = _RANDOM_76[12];	// @[util.scala:466:20]
        uops_6_uopc = _RANDOM_76[29:23];	// @[util.scala:466:20]
        uops_6_br_mask = {_RANDOM_81[31:19], _RANDOM_82[2:0]};	// @[util.scala:466:20]
        uops_6_rob_idx = _RANDOM_83[28:21];	// @[util.scala:466:20]
        uops_6_stq_idx = _RANDOM_84[6:2];	// @[util.scala:466:20]
        uops_6_pdst = _RANDOM_84[14:9];	// @[util.scala:466:20]
        uops_6_is_amo = _RANDOM_87[29];	// @[util.scala:466:20]
        uops_6_uses_stq = _RANDOM_87[31];	// @[util.scala:466:20]
        uops_6_dst_rtype = _RANDOM_88[30:29];	// @[util.scala:466:20]
        uops_6_fp_val = _RANDOM_89[4];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_89[17:15];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_89[20:18];	// @[Counter.scala:61:40, util.scala:466:20]
        maybe_full = _RANDOM_89[21];	// @[util.scala:466:20, :470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_30 ram_ext (	// @[util.scala:464:20]
  ...
  assign io_deq_valid = _io_empty_output ? io_enq_valid : ~_io_empty_output & _GEN_0 & (io_brupdate_b1_mispredict_mask & out_uop_br_mask) == 16'h0 & ~io_flush;	// @[util.scala:118:{51,59}, :473:25, :476:{42,69}, :508:19, :509:{27,108,111}, :515:21, :516:20]
  ...
  assign io_deq_bits_data = _io_empty_output ? io_enq_bits_data : _ram_ext_R0_data[472:408];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_predicated = ~_io_empty_output & _ram_ext_R0_data[473];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_valid = _io_empty_output ? io_enq_bits_fflags_valid : _ram_ext_R0_data[474];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_uop_rob_idx = _io_empty_output ? io_enq_bits_fflags_bits_uop_rob_idx : _ram_ext_R0_data[704:697];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
  assign io_deq_bits_fflags_bits_flags = _io_empty_output ? io_enq_bits_fflags_bits_flags : _ram_ext_R0_data[887:883];	// @[util.scala:464:20, :473:25, :510:27, :515:21, :517:19]
