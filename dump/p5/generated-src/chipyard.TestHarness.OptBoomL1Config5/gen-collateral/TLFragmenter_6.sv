...
module TLFragmenter_6(
  ...
  wire [20:0] _repeater_io_deq_bits_address;	// @[Fragmenter.scala:263:30]
  ...
  Repeater_10 repeater (	// @[Fragmenter.scala:263:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_address = _repeater_io_deq_bits_address | {15'h0, ~(_aOrigOH1_T_1[5:0] | {old_gennum1, ~(_aFragOH1_T_1[2:0])} | 6'h7)};	// @[Fragmenter.scala:263:30, :294:30, :305:{49,51,100,111}, package.scala:235:{46,71,76}]
