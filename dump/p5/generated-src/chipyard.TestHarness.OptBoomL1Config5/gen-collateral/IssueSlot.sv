...
module IssueSlot(
  ...
  input  [7:0]  io_in_uop_bits_rob_idx,
  ...
  reg  [7:0]  slot_uop_rob_idx;	// @[issue-slot.scala:102:25]
  ...
  wire        _GEN = io_kill | _T_7;	// @[issue-slot.scala:102:25, :131:18, :133:52, :134:63, :139:51]
  ...
  wire        _GEN_2 = (|(io_brupdate_b1_mispredict_mask & slot_uop_br_mask)) | io_kill | _T_7;	// @[issue-slot.scala:102:25, :131:18, :132:16, :133:52, :134:63, :136:62, :139:51, :231:50, :232:16, util.scala:118:{51,59}]
  wire        _may_vacate_T = state == 2'h1;	// @[issue-slot.scala:86:22, :133:36, :245:15]
  wire        _T_73 = state == 2'h2;	// @[consts.scala:277:20, issue-slot.scala:86:22, :260:65]
  wire        _T_75 = p1 & p2 & ppred;	// @[issue-slot.scala:87:22, :88:22, :90:22, :278:20]
  wire        _T_76 = p1 & ppred;	// @[issue-slot.scala:87:22, :90:22, :280:21]
  wire        _GEN_3 = ~_T_73 | _T_75 | _T_76 | ~(p2 & ppred);	// @[issue-slot.scala:88:22, :90:22, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}, :281:19, :283:{21,31}]
  wire [5:0]  next_uop_prs1 = io_in_uop_valid ? io_in_uop_bits_prs1 : slot_uop_prs1;	// @[issue-slot.scala:102:25, :103:21]
  wire [5:0]  next_uop_prs2 = io_in_uop_valid ? io_in_uop_bits_prs2 : slot_uop_prs2;	// @[issue-slot.scala:102:25, :103:21]
  wire [5:0]  next_uop_prs3 = io_in_uop_valid ? io_in_uop_bits_prs3 : slot_uop_prs3;	// @[issue-slot.scala:102:25, :103:21]
  always @(posedge clock) begin
    if (reset) begin
      ...
      slot_uop_uopc <= 7'h0;	// @[consts.scala:271:20, issue-slot.scala:102:25]
      slot_uop_pdst <= 6'h0;	// @[consts.scala:270:20, issue-slot.scala:102:25]
      ...
      else if (io_clear | _GEN_2)	// @[issue-slot.scala:114:26, :115:11, :117:11, :131:18, :132:16, :134:63, :136:62, :139:51, :231:50, :232:16]
        state <= 2'h0;	// @[issue-slot.scala:86:22, :126:14, :136:62, :137:18]
      else if (_T_12)	// @[issue-slot.scala:139:25]
        state <= 2'h1;	// @[issue-slot.scala:86:22, :133:36]
      p1 <= io_wakeup_ports_1_valid & io_wakeup_ports_1_bits_pdst == next_uop_prs1 | io_wakeup_ports_0_valid & io_wakeup_ports_0_bits_pdst == next_uop_prs1 | (io_in_uop_valid ? ~io_in_uop_bits_prs1_busy : p1);	// @[issue-slot.scala:87:22, :103:21, :168:26, :169:{8,11}, :175:45, :185:36, :186:{40,60}, :187:10, :211:39, :212:10]
      p2 <= io_wakeup_ports_1_valid & io_wakeup_ports_1_bits_pdst == next_uop_prs2 | io_wakeup_ports_0_valid & io_wakeup_ports_0_bits_pdst == next_uop_prs2 | (io_in_uop_valid ? ~io_in_uop_bits_prs2_busy : p2);	// @[issue-slot.scala:88:22, :103:21, :168:26, :170:{8,11}, :179:45, :189:36, :190:{40,60}, :191:10, :218:39, :219:10]
      p3 <= io_wakeup_ports_1_valid & io_wakeup_ports_1_bits_pdst == next_uop_prs3 | io_wakeup_ports_0_valid & io_wakeup_ports_0_bits_pdst == next_uop_prs3 | (io_in_uop_valid ? ~io_in_uop_bits_prs3_busy : p3);	// @[issue-slot.scala:89:22, :103:21, :168:26, :171:{8,11}, :193:36, :194:{40,60}, :195:10]
      ...
      else if (_GEN_0) begin	// @[issue-slot.scala:102:25, :131:18, :134:63, :139:51]
      end
    ...
    if (io_in_uop_valid) begin
      ...
      if (_GEN_0) begin	// @[issue-slot.scala:102:25, :131:18, :134:63, :139:51]
      end
      else	// @[issue-slot.scala:102:25, :131:18, :134:63, :139:51]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[issue-slot.scala:156:12]
      if (io_in_uop_valid & ~reset & ~(state == 2'h0 | io_clear | io_kill)) begin	// @[issue-slot.scala:78:26, :86:22, :126:14, :136:62, :137:18, :156:{12,36}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        slot_uop_br_mask = _RANDOM_5[19:4];	// @[issue-slot.scala:102:25]
        slot_uop_br_tag = _RANDOM_5[23:20];	// @[issue-slot.scala:102:25]
        slot_uop_ftq_idx = _RANDOM_5[29:24];	// @[issue-slot.scala:102:25]
        slot_uop_edge_inst = _RANDOM_5[30];	// @[issue-slot.scala:102:25]
        slot_uop_pc_lob = {_RANDOM_5[31], _RANDOM_6[4:0]};	// @[issue-slot.scala:102:25]
        slot_uop_taken = _RANDOM_6[5];	// @[issue-slot.scala:102:25]
        slot_uop_imm_packed = _RANDOM_6[25:6];	// @[issue-slot.scala:102:25]
        slot_uop_csr_addr = {_RANDOM_6[31:26], _RANDOM_7[5:0]};	// @[issue-slot.scala:102:25]
        slot_uop_rob_idx = _RANDOM_7[13:6];	// @[issue-slot.scala:102:25]
        slot_uop_ldq_idx = _RANDOM_7[18:14];	// @[issue-slot.scala:102:25]
        slot_uop_stq_idx = _RANDOM_7[23:19];	// @[issue-slot.scala:102:25]
        slot_uop_rxq_idx = _RANDOM_7[25:24];	// @[issue-slot.scala:102:25]
        slot_uop_pdst = _RANDOM_7[31:26];	// @[issue-slot.scala:102:25]
        slot_uop_prs1 = _RANDOM_8[5:0];	// @[issue-slot.scala:102:25]
        slot_uop_prs2 = _RANDOM_8[11:6];	// @[issue-slot.scala:102:25]
        slot_uop_prs3 = _RANDOM_8[17:12];	// @[issue-slot.scala:102:25]
        slot_uop_ppred = _RANDOM_8[23:18];	// @[issue-slot.scala:102:25]
        slot_uop_prs1_busy = _RANDOM_8[24];	// @[issue-slot.scala:102:25]
        slot_uop_prs2_busy = _RANDOM_8[25];	// @[issue-slot.scala:102:25]
        slot_uop_prs3_busy = _RANDOM_8[26];	// @[issue-slot.scala:102:25]
        slot_uop_ppred_busy = _RANDOM_8[27];	// @[issue-slot.scala:102:25]
        slot_uop_stale_pdst = {_RANDOM_8[31:28], _RANDOM_9[1:0]};	// @[issue-slot.scala:102:25]
        slot_uop_exception = _RANDOM_9[2];	// @[issue-slot.scala:102:25]
        slot_uop_exc_cause = {_RANDOM_9[31:3], _RANDOM_10, _RANDOM_11[2:0]};	// @[issue-slot.scala:102:25]
        slot_uop_bypassable = _RANDOM_11[3];	// @[issue-slot.scala:102:25]
        slot_uop_mem_cmd = _RANDOM_11[8:4];	// @[issue-slot.scala:102:25]
        slot_uop_mem_size = _RANDOM_11[10:9];	// @[issue-slot.scala:102:25]
        slot_uop_mem_signed = _RANDOM_11[11];	// @[issue-slot.scala:102:25]
        slot_uop_is_fence = _RANDOM_11[12];	// @[issue-slot.scala:102:25]
        slot_uop_is_fencei = _RANDOM_11[13];	// @[issue-slot.scala:102:25]
        slot_uop_is_amo = _RANDOM_11[14];	// @[issue-slot.scala:102:25]
        slot_uop_uses_ldq = _RANDOM_11[15];	// @[issue-slot.scala:102:25]
        slot_uop_uses_stq = _RANDOM_11[16];	// @[issue-slot.scala:102:25]
        slot_uop_is_sys_pc2epc = _RANDOM_11[17];	// @[issue-slot.scala:102:25]
        slot_uop_is_unique = _RANDOM_11[18];	// @[issue-slot.scala:102:25]
        slot_uop_flush_on_commit = _RANDOM_11[19];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_is_rs1 = _RANDOM_11[20];	// @[issue-slot.scala:102:25]
        slot_uop_ldst = _RANDOM_11[26:21];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1 = {_RANDOM_11[31:27], _RANDOM_12[0]};	// @[issue-slot.scala:102:25]
        slot_uop_lrs2 = _RANDOM_12[6:1];	// @[issue-slot.scala:102:25]
        slot_uop_lrs3 = _RANDOM_12[12:7];	// @[issue-slot.scala:102:25]
        slot_uop_ldst_val = _RANDOM_12[13];	// @[issue-slot.scala:102:25]
        slot_uop_dst_rtype = _RANDOM_12[15:14];	// @[issue-slot.scala:102:25]
        slot_uop_lrs1_rtype = _RANDOM_12[17:16];	// @[issue-slot.scala:102:25]
        slot_uop_lrs2_rtype = _RANDOM_12[19:18];	// @[issue-slot.scala:102:25]
        slot_uop_frs3_en = _RANDOM_12[20];	// @[issue-slot.scala:102:25]
        slot_uop_fp_val = _RANDOM_12[21];	// @[issue-slot.scala:102:25]
        slot_uop_fp_single = _RANDOM_12[22];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_pf_if = _RANDOM_12[23];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ae_if = _RANDOM_12[24];	// @[issue-slot.scala:102:25]
        slot_uop_xcpt_ma_if = _RANDOM_12[25];	// @[issue-slot.scala:102:25]
        slot_uop_bp_debug_if = _RANDOM_12[26];	// @[issue-slot.scala:102:25]
        slot_uop_bp_xcpt_if = _RANDOM_12[27];	// @[issue-slot.scala:102:25]
        slot_uop_debug_fsrc = _RANDOM_12[29:28];	// @[issue-slot.scala:102:25]
        slot_uop_debug_tsrc = _RANDOM_12[31:30];	// @[issue-slot.scala:102:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_will_be_valid = (|state) & ~(io_grant & (_may_vacate_T | _T_73 & p1 & p2 & ppred));	// @[issue-slot.scala:79:24, :86:22, :87:22, :88:22, :90:22, :245:15, :260:{29,55,65,92}, :262:{32,35}]
  ...
  assign io_out_uop_uopc = _GEN_0 ? slot_uop_uopc : 7'h3;	// @[issue-slot.scala:102:25, :131:18, :134:63, :139:51, :143:23]
  ...
  assign io_out_uop_iw_state = _GEN_2 ? 2'h0 : _T_12 ? 2'h1 : state;	// @[issue-slot.scala:86:22, :126:14, :131:18, :132:16, :133:36, :134:63, :136:62, :137:18, :139:{25,51}, :140:62, :141:18, :231:50, :232:16]
  ...
  assign io_out_uop_lrs1_rtype = _GEN_0 ? slot_uop_lrs1_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :131:18, :134:63, :139:51]
  assign io_out_uop_lrs2_rtype = _GEN_1 ? slot_uop_lrs2_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :131:18, :134:63, :139:51]
  ...
  assign io_uop_uopc = _GEN_3 ? slot_uop_uopc : 7'h3;	// @[issue-slot.scala:102:25, :143:23, :255:10, :277:30, :278:30]
  ...
  assign io_uop_lrs1_rtype = _GEN_3 ? slot_uop_lrs1_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :255:10, :277:30, :278:30]
  assign io_uop_lrs2_rtype = ~_T_73 | _T_75 | ~_T_76 ? slot_uop_lrs2_rtype : 2'h2;	// @[consts.scala:277:20, issue-slot.scala:102:25, :255:10, :260:65, :277:30, :278:{20,30}, :280:{21,31}]
