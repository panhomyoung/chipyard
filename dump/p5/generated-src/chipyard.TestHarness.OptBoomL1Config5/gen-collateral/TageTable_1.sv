...
module TageTable_1(
  ...
  wire [43:0] _table_R0_data;	// @[tage.scala:91:27]
  ...
  wire [6:0]  _GEN = {3'h0, io_f1_req_ghist[3:0]};	// @[tage.scala:53:11, :60:29, :67:20]
  wire [6:0]  _s2_req_rlous_T_1 = io_f1_req_pc[10:4] ^ _GEN;	// @[frontend.scala:163:35, tage.scala:60:29]
  ...
  wire [6:0]  _GEN_0 = {3'h0, io_update_hist[3:0]};	// @[tage.scala:53:11, :60:29, :67:20]
  wire [6:0]  update_idx = io_update_pc[10:4] ^ _GEN_0;	// @[frontend.scala:163:35, tage.scala:60:29]
  wire [6:0]  update_wdata_3_tag = io_update_pc[17:11] ^ _GEN_0;	// @[frontend.scala:163:35, tage.scala:60:29, :62:{30,50}]
  assign table_MPORT_data_0 = doing_reset ? 11'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_0};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_1 = doing_reset ? 11'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_1};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_2 = doing_reset ? 11'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_2};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  assign table_MPORT_data_3 = doing_reset ? 11'h0 : {1'h1, update_wdata_3_tag, _WIRE_5_3};	// @[tage.scala:62:50, :72:28, :123:{8,29,102}, :155:33]
  ...
  wire [2:0]  _GEN_1 = wrbypass_hits_0 ? wrbypass_0_0 : wrbypass_1_0;	// @[tage.scala:67:25, :143:29, :148:37]
  wire [2:0]  _GEN_2 = wrbypass_hits_0 ? wrbypass_0_1 : wrbypass_1_1;	// @[tage.scala:67:25, :143:29, :148:37]
  wire [2:0]  _GEN_3 = wrbypass_hits_0 ? wrbypass_0_2 : wrbypass_1_2;	// @[tage.scala:67:25, :143:29, :148:37]
  wire [2:0]  _GEN_4 = wrbypass_hits_0 ? wrbypass_0_3 : wrbypass_1_3;	// @[tage.scala:67:25, :143:29, :148:37]
  wire        _update_wdata_0_ctr_T_2 = _GEN_1 == 3'h0;	// @[tage.scala:67:{20,25}]
  wire [2:0]  _update_wdata_0_ctr_T_4 = _GEN_1 - 3'h1;	// @[tage.scala:67:{25,43}]
  wire [2:0]  _update_wdata_0_ctr_T_8 = _GEN_1 + 3'h1;	// @[tage.scala:67:{25,43}, :68:43]
  ...
  assign _WIRE_5_1 = io_update_alloc_1 ? (io_update_taken_1 ? 3'h4 : 3'h3) : wrbypass_hit ? (io_update_taken_1 ? ((&_GEN_2) ? 3'h7 : _update_wdata_1_ctr_T_8) : _update_wdata_1_ctr_T_2 ? 3'h0 : _update_wdata_1_ctr_T_4) : io_update_taken_1 ? ((&io_update_old_ctr_1) ? 3'h7 : _update_wdata_1_ctr_T_18) : _update_wdata_1_ctr_T_12 ? 3'h0 : _update_wdata_1_ctr_T_14;	// @[tage.scala:67:{8,20,25,43}, :68:{20,25,43}, :151:48, :155:33, :156:10, :159:10]
  assign update_hi_wdata_1 = io_update_u_1[1];	// @[tage.scala:166:44]
  assign update_lo_wdata_1 = io_update_u_1[0];	// @[tage.scala:167:44]
  wire        _update_wdata_2_ctr_T_2 = _GEN_3 == 3'h0;	// @[tage.scala:67:{20,25}]
  wire [2:0]  _update_wdata_2_ctr_T_4 = _GEN_3 - 3'h1;	// @[tage.scala:67:{25,43}]
  wire [2:0]  _update_wdata_2_ctr_T_8 = _GEN_3 + 3'h1;	// @[tage.scala:67:{25,43}, :68:43]
  ...
  assign _WIRE_5_2 = io_update_alloc_2 ? (io_update_taken_2 ? 3'h4 : 3'h3) : wrbypass_hit ? (io_update_taken_2 ? ((&_GEN_3) ? 3'h7 : _update_wdata_2_ctr_T_8) : _update_wdata_2_ctr_T_2 ? 3'h0 : _update_wdata_2_ctr_T_4) : io_update_taken_2 ? ((&io_update_old_ctr_2) ? 3'h7 : _update_wdata_2_ctr_T_18) : _update_wdata_2_ctr_T_12 ? 3'h0 : _update_wdata_2_ctr_T_14;	// @[tage.scala:67:{8,20,25,43}, :68:{20,25,43}, :151:48, :155:33, :156:10, :159:10]
  assign update_hi_wdata_2 = io_update_u_2[1];	// @[tage.scala:166:44]
  assign update_lo_wdata_2 = io_update_u_2[0];	// @[tage.scala:167:44]
  wire        _update_wdata_3_ctr_T_2 = _GEN_4 == 3'h0;	// @[tage.scala:67:{20,25}]
  wire [2:0]  _update_wdata_3_ctr_T_4 = _GEN_4 - 3'h1;	// @[tage.scala:67:{25,43}]
  wire [2:0]  _update_wdata_3_ctr_T_8 = _GEN_4 + 3'h1;	// @[tage.scala:67:{25,43}, :68:43]
  ...
  always @(posedge clock) begin
    ...
    s2_tag <= io_f1_req_pc[17:11] ^ _GEN;	// @[frontend.scala:163:35, tage.scala:60:29, :62:{30,50}, :95:29]
    io_f3_resp_0_valid_REG <= _table_R0_data[10] & _table_R0_data[9:3] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    ...
    io_f3_resp_1_valid_REG <= _table_R0_data[21] & _table_R0_data[20:14] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_1_bits_u_REG <= {_hi_us_R0_data[1], _lo_us_R0_data[1]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_1_bits_ctr_REG <= _table_R0_data[13:11];	// @[tage.scala:91:27, :97:87, :106:38]
    io_f3_resp_2_valid_REG <= _table_R0_data[32] & _table_R0_data[31:25] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_2_bits_u_REG <= {_hi_us_R0_data[2], _lo_us_R0_data[2]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_2_bits_ctr_REG <= _table_R0_data[24:22];	// @[tage.scala:91:27, :97:87, :106:38]
    io_f3_resp_3_valid_REG <= _table_R0_data[43] & _table_R0_data[42:36] == s2_tag & ~doing_reset;	// @[tage.scala:72:28, :91:27, :95:29, :97:87, :100:{69,80,83}, :104:38]
    io_f3_resp_3_bits_u_REG <= {_hi_us_R0_data[3], _lo_us_R0_data[3]};	// @[Cat.scala:33:92, tage.scala:89:27, :90:27, :105:38]
    io_f3_resp_3_bits_ctr_REG <= _table_R0_data[35:33];	// @[tage.scala:91:27, :97:87, :106:38]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reset_idx = _RANDOM_0[7:1];	// @[tage.scala:72:28, :73:26]
        s2_tag = _RANDOM_0[14:8];	// @[tage.scala:72:28, :95:29]
        io_f3_resp_0_valid_REG = _RANDOM_0[15];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_0_bits_u_REG = _RANDOM_0[17:16];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_0_bits_ctr_REG = _RANDOM_0[20:18];	// @[tage.scala:72:28, :106:38]
        io_f3_resp_1_valid_REG = _RANDOM_0[21];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_1_bits_u_REG = _RANDOM_0[23:22];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_1_bits_ctr_REG = _RANDOM_0[26:24];	// @[tage.scala:72:28, :106:38]
        io_f3_resp_2_valid_REG = _RANDOM_0[27];	// @[tage.scala:72:28, :104:38]
        io_f3_resp_2_bits_u_REG = _RANDOM_0[29:28];	// @[tage.scala:72:28, :105:38]
        io_f3_resp_2_bits_ctr_REG = {_RANDOM_0[31:30], _RANDOM_1[0]};	// @[tage.scala:72:28, :106:38]
        io_f3_resp_3_valid_REG = _RANDOM_1[1];	// @[tage.scala:104:38, :106:38]
        io_f3_resp_3_bits_u_REG = _RANDOM_1[3:2];	// @[tage.scala:105:38, :106:38]
        io_f3_resp_3_bits_ctr_REG = _RANDOM_1[6:4];	// @[tage.scala:106:38]
        clear_u_ctr = _RANDOM_1[25:7];	// @[tage.scala:106:38, :109:28]
        wrbypass_tags_0 = {_RANDOM_1[31:26], _RANDOM_2[0]};	// @[tage.scala:106:38, :141:29]
        wrbypass_tags_1 = _RANDOM_2[7:1];	// @[tage.scala:141:29]
        wrbypass_idxs_0 = _RANDOM_2[14:8];	// @[tage.scala:141:29, :142:29]
        wrbypass_idxs_1 = _RANDOM_2[21:15];	// @[tage.scala:141:29, :142:29]
        wrbypass_0_0 = _RANDOM_2[24:22];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_1 = _RANDOM_2[27:25];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_2 = _RANDOM_2[30:28];	// @[tage.scala:141:29, :143:29]
        wrbypass_0_3 = {_RANDOM_2[31], _RANDOM_3[1:0]};	// @[tage.scala:141:29, :143:29]
        wrbypass_1_0 = _RANDOM_3[4:2];	// @[tage.scala:143:29]
        wrbypass_1_1 = _RANDOM_3[7:5];	// @[tage.scala:143:29]
        wrbypass_1_2 = _RANDOM_3[10:8];	// @[tage.scala:143:29]
        wrbypass_1_3 = _RANDOM_3[13:11];	// @[tage.scala:143:29]
        wrbypass_enq_idx = _RANDOM_3[14];	// @[tage.scala:143:29, :144:33]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  hi_us_0 hi_us (	// @[tage.scala:89:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
    .W0_addr (doing_reset ? reset_idx : doing_clear_u_hi ? clear_u_ctr[17:11] : update_idx),	// @[tage.scala:60:29, :72:28, :73:26, :109:28, :113:40, :115:33, :129:{8,36}]
    .W0_clk  (clock),
  ...
  lo_us_0 lo_us (	// @[tage.scala:90:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
    .W0_addr (doing_reset ? reset_idx : doing_clear_u_lo ? clear_u_ctr[17:11] : update_idx),	// @[tage.scala:60:29, :72:28, :73:26, :109:28, :114:40, :115:33, :136:{8,36}]
    .W0_clk  (clock),
  ...
  table_0_0 table_0 (	// @[tage.scala:91:27]
    .R0_addr (_s2_req_rlous_T_1),	// @[tage.scala:60:29]
    .R0_en   (io_f1_req_valid),
    .R0_clk  (clock),
