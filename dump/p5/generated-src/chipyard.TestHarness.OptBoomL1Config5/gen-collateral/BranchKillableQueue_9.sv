...
module BranchKillableQueue_9(
  ...
  wire [7:0][15:0] _GEN_2 = {{uops_0_br_mask}, {uops_0_br_mask}, {uops_0_br_mask}, {uops_4_br_mask}, {uops_3_br_mask}, {uops_2_br_mask}, {uops_1_br_mask}, {uops_0_br_mask}};	// @[util.scala:466:20, :508:19]
  wire [15:0]      out_uop_br_mask = _GEN_2[deq_ptr_value];	// @[Counter.scala:61:40, util.scala:508:19]
  wire [7:0][7:0]  _GEN_3 = {{uops_0_rob_idx}, {uops_0_rob_idx}, {uops_0_rob_idx}, {uops_4_rob_idx}, {uops_3_rob_idx}, {uops_2_rob_idx}, {uops_1_rob_idx}, {uops_0_rob_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][4:0]  _GEN_4 = {{uops_0_stq_idx}, {uops_0_stq_idx}, {uops_0_stq_idx}, {uops_4_stq_idx}, {uops_3_stq_idx}, {uops_2_stq_idx}, {uops_1_stq_idx}, {uops_0_stq_idx}};	// @[util.scala:466:20, :508:19]
  wire [7:0][5:0]  _GEN_5 = {{uops_0_pdst}, {uops_0_pdst}, {uops_0_pdst}, {uops_4_pdst}, {uops_3_pdst}, {uops_2_pdst}, {uops_1_pdst}, {uops_0_pdst}};	// @[util.scala:466:20, :508:19]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valids_4 <= ~(do_deq & deq_ptr_value == 3'h4) & (_GEN_19 | valids_4 & (io_brupdate_b1_mispredict_mask & uops_4_br_mask) == 16'h0 & ~io_flush);	// @[Counter.scala:61:40, :73:24, util.scala:118:{51,59}, :465:24, :466:20, :476:24, :481:{16,69,72}, :487:17, :489:33, :495:17, :496:27, :515:21, :520:14]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uops_0_br_mask = _RANDOM_5[16:1];	// @[util.scala:466:20]
        uops_0_rob_idx = _RANDOM_7[10:3];	// @[util.scala:466:20]
        uops_0_stq_idx = _RANDOM_7[20:16];	// @[util.scala:466:20]
        uops_0_pdst = _RANDOM_7[28:23];	// @[util.scala:466:20]
        uops_0_is_amo = _RANDOM_11[11];	// @[util.scala:466:20]
        uops_0_uses_stq = _RANDOM_11[13];	// @[util.scala:466:20]
        uops_0_dst_rtype = _RANDOM_12[12:11];	// @[util.scala:466:20]
        uops_0_fp_val = _RANDOM_12[18];	// @[util.scala:466:20]
        uops_1_uopc = {_RANDOM_12[31:29], _RANDOM_13[3:0]};	// @[util.scala:466:20]
        uops_1_br_mask = {_RANDOM_17[31:25], _RANDOM_18[8:0]};	// @[util.scala:466:20]
        uops_1_rob_idx = {_RANDOM_19[31:27], _RANDOM_20[2:0]};	// @[util.scala:466:20]
        uops_1_stq_idx = _RANDOM_20[12:8];	// @[util.scala:466:20]
        uops_1_pdst = _RANDOM_20[20:15];	// @[util.scala:466:20]
        uops_1_is_amo = _RANDOM_24[3];	// @[util.scala:466:20]
        uops_1_uses_stq = _RANDOM_24[5];	// @[util.scala:466:20]
        uops_1_dst_rtype = _RANDOM_25[4:3];	// @[util.scala:466:20]
        uops_1_fp_val = _RANDOM_25[10];	// @[util.scala:466:20]
        uops_2_uopc = _RANDOM_25[27:21];	// @[util.scala:466:20]
        uops_2_br_mask = {_RANDOM_30[31:17], _RANDOM_31[0]};	// @[util.scala:466:20]
        uops_2_rob_idx = _RANDOM_32[26:19];	// @[util.scala:466:20]
        uops_2_stq_idx = _RANDOM_33[4:0];	// @[util.scala:466:20]
        uops_2_pdst = _RANDOM_33[12:7];	// @[util.scala:466:20]
        uops_2_is_amo = _RANDOM_36[27];	// @[util.scala:466:20]
        uops_2_uses_stq = _RANDOM_36[29];	// @[util.scala:466:20]
        uops_2_dst_rtype = _RANDOM_37[28:27];	// @[util.scala:466:20]
        uops_2_fp_val = _RANDOM_38[2];	// @[util.scala:466:20]
        uops_3_uopc = _RANDOM_38[19:13];	// @[util.scala:466:20]
        uops_3_br_mask = _RANDOM_43[24:9];	// @[util.scala:466:20]
        uops_3_rob_idx = _RANDOM_45[18:11];	// @[util.scala:466:20]
        uops_3_stq_idx = _RANDOM_45[28:24];	// @[util.scala:466:20]
        uops_3_pdst = {_RANDOM_45[31], _RANDOM_46[4:0]};	// @[util.scala:466:20]
        uops_3_is_amo = _RANDOM_49[19];	// @[util.scala:466:20]
        uops_3_uses_stq = _RANDOM_49[21];	// @[util.scala:466:20]
        uops_3_dst_rtype = _RANDOM_50[20:19];	// @[util.scala:466:20]
        uops_3_fp_val = _RANDOM_50[26];	// @[util.scala:466:20]
        uops_4_uopc = _RANDOM_51[11:5];	// @[util.scala:466:20]
        uops_4_br_mask = _RANDOM_56[16:1];	// @[util.scala:466:20]
        uops_4_rob_idx = _RANDOM_58[10:3];	// @[util.scala:466:20]
        uops_4_stq_idx = _RANDOM_58[20:16];	// @[util.scala:466:20]
        uops_4_pdst = _RANDOM_58[28:23];	// @[util.scala:466:20]
        uops_4_is_amo = _RANDOM_62[11];	// @[util.scala:466:20]
        uops_4_uses_stq = _RANDOM_62[13];	// @[util.scala:466:20]
        uops_4_dst_rtype = _RANDOM_63[12:11];	// @[util.scala:466:20]
        uops_4_fp_val = _RANDOM_63[18];	// @[util.scala:466:20]
        enq_ptr_value = _RANDOM_63[31:29];	// @[Counter.scala:61:40, util.scala:466:20]
        deq_ptr_value = _RANDOM_64[2:0];	// @[Counter.scala:61:40]
        maybe_full = _RANDOM_64[3];	// @[Counter.scala:61:40, util.scala:470:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ram_combMem_29 ram_ext (	// @[util.scala:464:20]
